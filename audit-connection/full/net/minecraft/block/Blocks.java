...
public class Blocks {
	...
	public static final Block PALE_OAK_WOOD = register(
		"pale_oak_wood",
		PillarBlock::new,
		AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).instrument(NoteBlockInstrument.BASS).strength(2.0F).sounds(BlockSoundGroup.WOOD).burnable()
	);
	...
	public static final Block SAND = register(
		"sand",
		settings -> new SandBlock(new ColorCode(14406560), settings),
	...
	public static final Block RED_SAND = register(
		"red_sand",
		settings -> new SandBlock(new ColorCode(11098145), settings),
	...
	public static final Block PALE_OAK_LOG = register(
		"pale_oak_log", PillarBlock::new, createLogSettings(PALE_OAK_PLANKS.getDefaultMapColor(), PALE_OAK_WOOD.getDefaultMapColor(), BlockSoundGroup.WOOD)
	);
	...
	public static final Block STRIPPED_PALE_OAK_LOG = register(
		...
		PillarBlock::new,
		createLogSettings(PALE_OAK_PLANKS.getDefaultMapColor(), PALE_OAK_PLANKS.getDefaultMapColor(), BlockSoundGroup.WOOD)
	);
	...
	public static final Block OAK_LEAVES = register(
		"oak_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block SPRUCE_LEAVES = register(
		"spruce_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block BIRCH_LEAVES = register(
		"birch_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block JUNGLE_LEAVES = register(
		"jungle_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block ACACIA_LEAVES = register(
		"acacia_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	...
	public static final Block DARK_OAK_LEAVES = register(
		"dark_oak_leaves", settings -> new TintedParticleLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block PALE_OAK_LEAVES = register(
		"pale_oak_leaves",
		settings -> new UntintedParticleLeavesBlock(0.02F, ParticleTypes.PALE_OAK_LEAVES, settings),
		AbstractBlock.Settings.create()
			.mapColor(MapColor.IRON_GRAY)
			.strength(0.2F)
			.ticksRandomly()
	...
	public static final Block MANGROVE_LEAVES = register(
		"mangrove_leaves", settings -> new MangroveLeavesBlock(0.01F, settings), createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block AZALEA_LEAVES = register(
		"azalea_leaves",
		settings -> new UntintedParticleLeavesBlock(0.01F, EntityEffectParticleEffect.create(ParticleTypes.TINTED_LEAVES, -9399763), settings),
		createLeavesSettings(BlockSoundGroup.AZALEA_LEAVES)
	);
	...
	public static final Block CREAKING_HEART = register(
		...
		AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.BASEDRUM).strength(10.0F).sounds(BlockSoundGroup.CREAKING_HEART)
	);
	...
	public static final Block IRON_BARS = register(
		"iron_bars", PaneBlock::new, AbstractBlock.Settings.create().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.IRON).nonOpaque()
	);
	...
	public static final Block RESIN_BLOCK = register(
		"resin_block", AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).sounds(BlockSoundGroup.RESIN)
	);
	...
	public static final Block RESIN_BRICK_STAIRS = registerOldStairsBlock("resin_brick_stairs", RESIN_BRICKS);
	...
	public static final Block BREWING_STAND = register(
		"brewing_stand", BrewingStandBlock::new, AbstractBlock.Settings.create().mapColor(MapColor.IRON_GRAY).strength(0.5F).luminance(state -> 1).nonOpaque()
	);
	...
	public static final Block ENDER_CHEST = register(
		"ender_chest",
		EnderChestBlock::new,
		AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).instrument(NoteBlockInstrument.BASEDRUM).strength(22.5F, 600.0F).luminance(state -> 7)
	);
	...
	public static final Block POTTED_PALE_OAK_SAPLING = register(
		"potted_pale_oak_sapling", settings -> new FlowerPotBlock(PALE_OAK_SAPLING, settings), createFlowerPotSettings()
	);
	...
	public static final Block PALE_OAK_BUTTON = register(
		"pale_oak_button", settings -> new ButtonBlock(BlockSetType.PALE_OAK, 30, settings), createButtonSettings()
	);
	...
	public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register(
		...
		AbstractBlock.Settings.create().mapColor(MapColor.IRON_GRAY).solid().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block BELL = register(
		"bell",
		BellBlock::new,
		AbstractBlock.Settings.create().mapColor(MapColor.GOLD).solid().strength(5.0F).sounds(BlockSoundGroup.ANVIL).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block TEST_BLOCK = register(
		"test_block", TestBlock::new, AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).strength(-1.0F, 3600000.0F).dropsNothing()
	);
	public static final Block TEST_INSTANCE_BLOCK = register(
		"test_instance_block",
		TestInstanceBlock::new,
		AbstractBlock.Settings.create().nonOpaque().strength(-1.0F, 3600000.0F).dropsNothing().blockVision(Blocks::never)
	);
	...
	public static final Block LARGE_AMETHYST_BUD = register(
		"large_amethyst_bud",
		settings -> new AmethystClusterBlock(5.0F, 10.0F, settings),
	...
	public static final Block MEDIUM_AMETHYST_BUD = register(
		"medium_amethyst_bud",
		settings -> new AmethystClusterBlock(4.0F, 10.0F, settings),
	...
	public static final Block SMALL_AMETHYST_BUD = register(
		"small_amethyst_bud",
		settings -> new AmethystClusterBlock(3.0F, 8.0F, settings),
	...
	public static final Block COPPER_DOOR = register(
		...
		AbstractBlock.Settings.create().mapColor(COPPER_BLOCK.getDefaultMapColor()).strength(3.0F, 6.0F).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block OPEN_EYEBLOSSOM = register(
		"open_eyeblossom",
		settings -> new EyeblossomBlock(EyeblossomBlock.EyeblossomState.OPEN, settings),
		AbstractBlock.Settings.create()
	...
	public static final Block CLOSED_EYEBLOSSOM = register(
		"closed_eyeblossom",
		settings -> new EyeblossomBlock(EyeblossomBlock.EyeblossomState.CLOSED, settings),
		AbstractBlock.Settings.create()
	...
	public static final Block POTTED_OPEN_EYEBLOSSOM = register(
		"potted_open_eyeblossom", settings -> new FlowerPotBlock(OPEN_EYEBLOSSOM, settings), createFlowerPotSettings().ticksRandomly()
	);
	public static final Block POTTED_CLOSED_EYEBLOSSOM = register(
		"potted_closed_eyeblossom", settings -> new FlowerPotBlock(CLOSED_EYEBLOSSOM, settings), createFlowerPotSettings().ticksRandomly()
	);
