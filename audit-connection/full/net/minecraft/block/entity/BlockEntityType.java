...
public class BlockEntityType<T extends BlockEntity> implements FabricBlockEntityType {
	...
	public static final BlockEntityType<TestBlockEntity> TEST_BLOCK = create("test_block", TestBlockEntity::new, Blocks.TEST_BLOCK);
	public static final BlockEntityType<TestInstanceBlockEntity> TEST_INSTANCE_BLOCK = create(
