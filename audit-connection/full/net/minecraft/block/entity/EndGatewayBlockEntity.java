...
public class EndGatewayBlockEntity extends EndPortalBlockEntity {
	...
	protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
		...
		nbt.putNullable("exit_portal", BlockPos.CODEC, this.exitPortalPos);
	...
	protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
		...
		this.age = nbt.getLong("Age", 0L);
		this.exitPortalPos = (BlockPos)nbt.get("exit_portal", BlockPos.CODEC).filter(World::isValid).orElse(null);
		this.exactTeleport = nbt.getBoolean("ExactTeleport", false);
	}
