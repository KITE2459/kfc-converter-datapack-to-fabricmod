...
public class SculkSpreadManager {
	...
	public void readNbt(NbtCompound nbt) {
		this.cursors.clear();
		((List)nbt.get("cursors", SculkSpreadManager.Cursor.CODEC.sizeLimitedListOf(32)).orElse(List.of())).forEach(this::addCursor);
	}

	public void writeNbt(NbtCompound nbt) {
		nbt.put("cursors", SculkSpreadManager.Cursor.CODEC.listOf(), this.cursors);
	}
