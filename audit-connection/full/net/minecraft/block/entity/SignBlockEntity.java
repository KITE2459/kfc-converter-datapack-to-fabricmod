...
public class SignBlockEntity extends BlockEntity {
	...
	protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
		...
		nbt.put("front_text", SignText.CODEC, dynamicOps, this.frontText);
		nbt.put("back_text", SignText.CODEC, dynamicOps, this.backText);
	...
	protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
		...
		DynamicOps<NbtElement> dynamicOps = registries.getOps(NbtOps.INSTANCE);
		this.frontText = (SignText)nbt.get("front_text", SignText.CODEC, dynamicOps).map(this::parseLines).orElseGet(SignText::new);
		this.backText = (SignText)nbt.get("back_text", SignText.CODEC, dynamicOps).map(this::parseLines).orElseGet(SignText::new);
