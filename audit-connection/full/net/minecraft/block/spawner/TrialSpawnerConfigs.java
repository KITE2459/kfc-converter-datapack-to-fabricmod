...
public class TrialSpawnerConfigs {
	...
	public static void bootstrap(Registerable<TrialSpawnerConfig> registry) {
		register(
			...
			TrialSpawnerConfig.builder()
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.BREEZE)))
				.build(),
			TrialSpawnerConfig.builder()
				.simultaneousMobsAddedPerPlayer(0.5F)
				.ticksBetweenSpawn(20)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.BREEZE)))
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
		...
		register(
			registry,
			MELEE_HUSK,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.HUSK))).build(),
			genericBuilder()
				.spawnPotentials(Pool.of(createEntry(EntityType.HUSK, LootTables.TRIAL_CHAMBER_MELEE_EQUIPMENT)))
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_CONSUMABLES_SPAWNER, 7)
		...
		register(
			registry,
			MELEE_SPIDER,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.SPIDER))).build(),
			ominousMeleeBuilder()
				.spawnPotentials(Pool.of(createEntry(EntityType.SPIDER)))
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_CONSUMABLES_SPAWNER, 7)
		...
		register(
			registry,
			MELEE_ZOMBIE,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.ZOMBIE))).build(),
			genericBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.ZOMBIE, LootTables.TRIAL_CHAMBER_MELEE_EQUIPMENT)))
				.build()
		);
		register(
			registry,
			RANGED_POISON_SKELETON,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.BOGGED))).build(),
			genericBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.BOGGED, LootTables.TRIAL_CHAMBER_RANGED_EQUIPMENT)))
				.build()
		);
		register(
			registry,
			RANGED_SKELETON,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.SKELETON))).build(),
			genericBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.SKELETON, LootTables.TRIAL_CHAMBER_RANGED_EQUIPMENT)))
				.build()
		);
		register(
			registry,
			RANGED_STRAY,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.STRAY))).build(),
			genericBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.STRAY, LootTables.TRIAL_CHAMBER_RANGED_EQUIPMENT)))
				.build()
		);
		register(
			registry,
			SLOW_RANGED_POISON_SKELETON,
			slowRangedBuilder().spawnPotentials(Pool.of(createEntry(EntityType.BOGGED))).build(),
			slowRangedBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
		...
		register(
			...
			slowRangedBuilder().spawnPotentials(Pool.of(createEntry(EntityType.SKELETON))).build(),
			slowRangedBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
		...
		register(
			registry,
			SLOW_RANGED_STRAY,
			slowRangedBuilder().spawnPotentials(Pool.of(createEntry(EntityType.STRAY))).build(),
			slowRangedBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
		...
		register(
			...
			TrialSpawnerConfig.builder()
				.simultaneousMobsAddedPerPlayer(0.5F)
				.ticksBetweenSpawn(20)
				.spawnPotentials(Pool.of(createEntry(EntityType.ZOMBIE, nbt -> nbt.putBoolean("IsBaby", true), null)))
				.build(),
			TrialSpawnerConfig.builder()
				.simultaneousMobsAddedPerPlayer(0.5F)
				.ticksBetweenSpawn(20)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.ZOMBIE, nbt -> nbt.putBoolean("IsBaby", true), LootTables.TRIAL_CHAMBER_MELEE_EQUIPMENT)))
				.build()
		);
		register(
			registry,
			SMALL_MELEE_CAVE_SPIDER,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.CAVE_SPIDER))).build(),
			ominousMeleeBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.CAVE_SPIDER)))
				.build()
		);
		register(
			registry,
			SMALL_MELEE_SILVERFISH,
			genericBuilder().spawnPotentials(Pool.of(createEntry(EntityType.SILVERFISH))).build(),
			ominousMeleeBuilder()
				.lootTablesToEject(
					Pool.<RegistryKey<LootTable>>builder()
						.add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3)
				...
				.spawnPotentials(Pool.of(createEntry(EntityType.SILVERFISH)))
				.build()
		);
		register(
			registry,
	...
	private static <T extends Entity> MobSpawnerEntry createEntry(EntityType<T> entityType) {
		return createEntry(entityType, nbt -> {}, null);
	}
	...
	private static <T extends Entity> MobSpawnerEntry createEntry(EntityType<T> entityType, RegistryKey<LootTable> equipmentTable) {
		return createEntry(entityType, nbt -> {}, equipmentTable);
	}
