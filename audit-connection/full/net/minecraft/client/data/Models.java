...
public class Models {
	...
	public static final Model CROSS_EMISSIVE = block("cross_emissive", TextureKey.CROSS, TextureKey.CROSS_EMISSIVE);
	...
	public static final Model FLOWER_POT_CROSS_EMISSIVE = block("flower_pot_cross_emissive", TextureKey.PLANT, TextureKey.CROSS_EMISSIVE);
	...
	public static final Model TEMPLATE_LEAF_LITTER_1 = block("template_leaf_litter_1", "_1", TextureKey.TEXTURE);
	public static final Model TEMPLATE_LEAF_LITTER_2 = block("template_leaf_litter_2", "_2", TextureKey.TEXTURE);
	public static final Model TEMPLATE_LEAF_LITTER_3 = block("template_leaf_litter_3", "_3", TextureKey.TEXTURE);
	public static final Model TEMPLATE_LEAF_LITTER_4 = block("template_leaf_litter_4", "_4", TextureKey.TEXTURE);
	...
	public static final Model TEMPLATE_TORCH_UNLIT = block("template_torch_unlit", TextureKey.TORCH);
	public static final Model TEMPLATE_TORCH_WALL = block("template_torch_wall", TextureKey.TORCH);
	public static final Model TEMPLATE_TORCH_WALL_UNLIT = block("template_torch_wall_unlit", TextureKey.TORCH);
	...
	public static final Model TEMPLATE_CHEST = item("template_chest", TextureKey.PARTICLE);
	public static final Model TEMPLATE_BUNDLE_OPEN_FRONT = openBundle("template_bundle_open_front", "_open_front", TextureKey.LAYER0);
	public static final Model TEMPLATE_BUNDLE_OPEN_BACK = openBundle("template_bundle_open_back", "_open_back", TextureKey.LAYER0);
	public static final Model BOW = item("bow", TextureKey.LAYER0);
	public static final Model CROSSBOW = item("crossbow", TextureKey.LAYER0);
