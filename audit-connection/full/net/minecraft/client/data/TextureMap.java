...
public class TextureMap {
	...
	public static TextureMap crossAndCrossEmissive(Block block) {
		return new TextureMap().put(TextureKey.CROSS, getId(block)).put(TextureKey.CROSS_EMISSIVE, getSubId(block, "_emissive"));
	}
	...
	public static TextureMap plantAndCrossEmissive(Block block) {
		return new TextureMap().put(TextureKey.PLANT, getId(block)).put(TextureKey.CROSS_EMISSIVE, getSubId(block, "_emissive"));
	}
