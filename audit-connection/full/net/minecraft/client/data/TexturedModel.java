...
public class TexturedModel {
	...
	public static final TexturedModel.Factory FLOWERBED_4 = makeFactory(TextureMap::flowerbed, Models.FLOWERBED_4);
	public static final TexturedModel.Factory TEMPLATE_LEAF_LITTER_1 = makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_1);
	public static final TexturedModel.Factory TEMPLATE_LEAF_LITTER_2 = makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_2);
	public static final TexturedModel.Factory TEMPLATE_LEAF_LITTER_3 = makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_3);
	public static final TexturedModel.Factory TEMPLATE_LEAF_LITTER_4 = makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_4);
	...
	public interface Factory {
		...
		default Identifier upload(Block block, BiConsumer<Identifier, ModelSupplier> writer) {
			return this.get(block).upload(block, writer);
		}

		default Identifier upload(Block block, String suffix, BiConsumer<Identifier, ModelSupplier> writer) {
