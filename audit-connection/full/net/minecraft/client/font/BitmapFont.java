				...
				new RenderableGlyph() {
					...
					public void upload(int x, int y, GpuTexture texture) {
						RenderSystem.getDevice()
							...
							.writeToTexture(
								texture, BitmapFontGlyph.this.image, 0, x, y, BitmapFontGlyph.this.width, BitmapFontGlyph.this.height, BitmapFontGlyph.this.x, BitmapFontGlyph.this.y
							);
					}
					...
					for (int o : this.codepointGrid[m]) {
						...
						if (o != 0) {
							...
							BitmapFont.BitmapFontGlyph bitmapFontGlyph = glyphContainer.put(
								o, new BitmapFont.BitmapFontGlyph(f, nativeImage, p * k, m * l, k, l, (int)(0.5 + q * f) + 1, this.ascent)
							);
