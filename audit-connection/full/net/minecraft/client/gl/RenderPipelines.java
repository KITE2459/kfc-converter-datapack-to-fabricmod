...
public class RenderPipelines {
	...
	public static final RenderPipeline.Snippet MATRICES_SNIPPET = RenderPipeline.builder()
		.withUniform("ModelViewMat", UniformType.MATRIX4X4)
		.withUniform("ProjMat", UniformType.MATRIX4X4)
		.buildSnippet();
	public static final RenderPipeline.Snippet FOG_NO_COLOR_SNIPPET = RenderPipeline.builder()
		.withUniform("FogStart", UniformType.FLOAT)
		.withUniform("FogEnd", UniformType.FLOAT)
		.withUniform("FogShape", UniformType.INT)
		.buildSnippet();
	public static final RenderPipeline.Snippet FOG_SNIPPET = RenderPipeline.builder(FOG_NO_COLOR_SNIPPET).withUniform("FogColor", UniformType.VEC4).buildSnippet();
	public static final RenderPipeline.Snippet MATRICES_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET)
		.withUniform("ColorModulator", UniformType.VEC4)
		.buildSnippet();
	public static final RenderPipeline.Snippet MATRICES_COLOR_FOG_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET).buildSnippet();
	public static final RenderPipeline.Snippet MATRICES_COLOR_FOG_OFFSET_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
		.withUniform("ModelOffset", UniformType.VEC3)
		.buildSnippet();
	public static final RenderPipeline.Snippet MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET)
		.withUniform("Light0_Direction", UniformType.VEC3)
		.withUniform("Light1_Direction", UniformType.VEC3)
		.buildSnippet();
	public static final RenderPipeline.Snippet TERRAIN_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET)
		...
		.buildSnippet();
	public static final RenderPipeline.Snippet ENTITY_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET)
		...
		.buildSnippet();
	public static final RenderPipeline.Snippet RENDERTYPE_BEACON_BEAM_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
		.withVertexShader("core/rendertype_beacon_beam")
		.withFragmentShader("core/rendertype_beacon_beam")
		.withSampler("Sampler0")
		.withVertexFormat(VertexFormats.POSITION_COLOR_TEXTURE_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS)
		.buildSnippet();
	public static final RenderPipeline.Snippet TEXT_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
		.withBlend(BlendFunction.TRANSLUCENT)
		.withVertexFormat(VertexFormats.POSITION_COLOR_TEXTURE_LIGHT, VertexFormat.DrawMode.QUADS)
		.buildSnippet();
	public static final RenderPipeline.Snippet RENDERTYPE_END_PORTAL_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET, FOG_SNIPPET)
		...
		.buildSnippet();
	public static final RenderPipeline.Snippet RENDERTYPE_CLOUDS_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_OFFSET_SNIPPET)
		.withVertexShader("core/rendertype_clouds")
		.withFragmentShader("core/rendertype_clouds")
		.withBlend(BlendFunction.TRANSLUCENT)
		.withVertexFormat(VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS)
		.buildSnippet();
	public static final RenderPipeline.Snippet RENDERTYPE_LINES_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
		...
		.buildSnippet();
	public static final RenderPipeline.Snippet POSITION_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
		.withVertexShader("core/position_color")
		.withFragmentShader("core/position_color")
		.withBlend(BlendFunction.TRANSLUCENT)
		.withVertexFormat(VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS)
		.buildSnippet();
	public static final RenderPipeline.Snippet PARTICLE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET)
	...
	public static final RenderPipeline.Snippet WEATHER_SNIPPET = RenderPipeline.builder(PARTICLE_SNIPPET)
		...
		.withCull(false)
		.buildSnippet();
	public static final RenderPipeline.Snippet GUI_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
		.withVertexShader("core/gui")
		.withFragmentShader("core/gui")
		.withBlend(BlendFunction.TRANSLUCENT)
		.withVertexFormat(VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS)
		.buildSnippet();
	public static final RenderPipeline.Snippet POSITION_TEX_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
		...
		.buildSnippet();
	public static final RenderPipeline.Snippet RENDERTYPE_OUTLINE_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET)
	...
	public static final RenderPipeline CLOUDS_DEPTH_ONLY = register(
		RenderPipeline.builder(RENDERTYPE_CLOUDS_SNIPPET).withLocation("pipeline/clouds_depth_only").withColorWrite(false).build()
	);
	...
	public static final RenderPipeline SECOND_BLOCK_OUTLINE = register(
		RenderPipeline.builder(RENDERTYPE_LINES_SNIPPET).withLocation("pipeline/secondary_block_outline").withDepthWrite(false).build()
	);
	...
	public static final RenderPipeline DEBUG_STRUCTURE_QUADS = register(
		RenderPipeline.builder(POSITION_COLOR_SNIPPET).withLocation("pipeline/debug_structure_quads").withCull(false).withDepthWrite(false).build()
	);
	public static final RenderPipeline DEBUG_SECTION_QUADS = register(
		RenderPipeline.builder(POSITION_COLOR_SNIPPET).withLocation("pipeline/debug_section_quads").build()
	);
