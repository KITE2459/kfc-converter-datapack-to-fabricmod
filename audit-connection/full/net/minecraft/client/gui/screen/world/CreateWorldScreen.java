...
public class CreateWorldScreen extends Screen {
	...
	private final TabManager tabManager = new TabManager(element -> {
	...
	private static void show(
		...
		DataConfiguration dataConfiguration = SharedConstants.isDevelopment
			? new DataConfiguration(new DataPackSettings(List.of("vanilla", "tests"), List.of()), FeatureFlags.DEFAULT_ENABLED_FEATURES)
