...
public enum GraphicsMode implements TranslatableOption {
	...
	private static final IntFunction<GraphicsMode> BY_ID = ValueLists.createIndexToValueFunction(
		GraphicsMode::getId, values(), ValueLists.OutOfBoundsHandling.WRAP
	);
