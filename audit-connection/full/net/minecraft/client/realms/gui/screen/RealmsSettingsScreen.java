...
public class RealmsSettingsScreen extends RealmsScreen {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
		...
		context.drawTextWithShadow(this.textRenderer, WORLD_NAME_TEXT, this.width / 2 - 106, row(3), Colors.WHITE);
		context.drawTextWithShadow(this.textRenderer, WORLD_DESCRIPTION_TEXT, this.width / 2 - 106, row(7), Colors.WHITE);
	}
