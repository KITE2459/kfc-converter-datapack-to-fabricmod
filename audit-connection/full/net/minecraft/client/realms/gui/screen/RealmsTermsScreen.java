...
public class RealmsTermsScreen extends RealmsScreen {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
		...
		context.drawTextWithShadow(this.textRenderer, SENTENCE_ONE_TEXT, this.width / 2 - 120, row(5), Colors.WHITE);
		...
		context.drawTextWithShadow(this.textRenderer, SENTENCE_TWO_TEXT, this.width / 2 - 120 + i, row(5), this.onLink ? 7107012 : 3368635);
	}
}
