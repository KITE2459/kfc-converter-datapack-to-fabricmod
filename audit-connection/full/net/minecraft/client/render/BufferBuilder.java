	...
	private void endVertex() {
		if (this.vertexCount != 0) {
			if (this.currentMask != 0) {
				String string = (String)VertexFormatElement.elementsFromMask(this.currentMask).map(this.vertexFormat::getElementName).collect(Collectors.joining(", "));
