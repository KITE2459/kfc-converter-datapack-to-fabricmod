		...
		for (MapRenderState.Decoration decoration : state.decorations) {
			if (!bl || decoration.alwaysRendered) {
				...
				if (sprite != null) {
					...
					vertexConsumer2.vertex(matrix4f2, -1.0F, 1.0F, i * -0.001F).color(Colors.WHITE).texture(sprite.getMinU(), sprite.getMinV()).light(light);
					vertexConsumer2.vertex(matrix4f2, 1.0F, 1.0F, i * -0.001F).color(Colors.WHITE).texture(sprite.getMaxU(), sprite.getMinV()).light(light);
					vertexConsumer2.vertex(matrix4f2, 1.0F, -1.0F, i * -0.001F).color(Colors.WHITE).texture(sprite.getMaxU(), sprite.getMaxV()).light(light);
					vertexConsumer2.vertex(matrix4f2, -1.0F, -1.0F, i * -0.001F).color(Colors.WHITE).texture(sprite.getMinU(), sprite.getMaxV()).light(light);
					matrices.pop();
				}
