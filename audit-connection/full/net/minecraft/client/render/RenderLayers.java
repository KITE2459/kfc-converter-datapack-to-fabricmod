...
public class RenderLayers {
	private static final Map<Block, RenderLayer> BLOCKS = Util.make(Maps.<Block, RenderLayer>newHashMap(), map -> {
		...
		map.put(Blocks.BUSH, renderLayer3);
		map.put(Blocks.DEAD_BUSH, renderLayer3);
		map.put(Blocks.SHORT_DRY_GRASS, renderLayer3);
		map.put(Blocks.TALL_DRY_GRASS, renderLayer3);
		map.put(Blocks.SEAGRASS, renderLayer3);
		map.put(Blocks.TALL_SEAGRASS, renderLayer3);
		map.put(Blocks.DANDELION, renderLayer3);
		map.put(Blocks.OPEN_EYEBLOSSOM, renderLayer3);
		map.put(Blocks.CLOSED_EYEBLOSSOM, renderLayer3);
		...
		map.put(Blocks.RESIN_CLUMP, renderLayer3);
		...
		map.put(Blocks.POTTED_OPEN_EYEBLOSSOM, renderLayer3);
		map.put(Blocks.POTTED_CLOSED_EYEBLOSSOM, renderLayer3);
		...
		map.put(Blocks.WILDFLOWERS, renderLayer3);
		map.put(Blocks.LEAF_LITTER, renderLayer3);
		...
		map.put(Blocks.FIREFLY_BUSH, renderLayer3);
		map.put(Blocks.CACTUS_FLOWER, renderLayer3);
