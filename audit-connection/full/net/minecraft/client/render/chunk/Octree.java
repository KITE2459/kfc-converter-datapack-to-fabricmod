...
public class Octree {
	...
	boolean isCenterWithin(double minX, double minY, double minZ, double maxX, double maxY, double maxZ, int margin) {
		...
		return i > minX - margin && i < maxX + margin && j > minY - margin && j < maxY + margin && k > minZ - margin && k < maxZ + margin;
	}
			...
			if (bl) {
				nearCenter = nearCenter
					&& Octree.this.isCenterWithin(
						this.box.getMinX(), this.box.getMinY(), this.box.getMinZ(), this.box.getMaxX(), this.box.getMaxY(), this.box.getMaxZ(), margin
					);
