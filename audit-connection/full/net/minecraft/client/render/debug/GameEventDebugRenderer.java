		...
		if (world == null) {
			...
			for (GameEventDebugRenderer.Listener listener : this.listeners) {
				listener.getPos(world)
					.ifPresent(
						pos -> {
							double gx = pos.getX() - listener.getRange();
							double hx = pos.getY() - listener.getRange();
							double ix = pos.getZ() - listener.getRange();
							double jx = pos.getX() + listener.getRange();
							double k = pos.getY() + listener.getRange();
							double l = pos.getZ() + listener.getRange();
