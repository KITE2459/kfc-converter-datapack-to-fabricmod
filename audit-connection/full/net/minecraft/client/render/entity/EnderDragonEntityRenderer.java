...
public class EnderDragonEntityRenderer extends EntityRenderer<EnderDragonEntity, EnderDragonEntityRenderState> {
	...
	protected void appendHitboxes(EnderDragonEntity enderDragonEntity, Builder<EntityHitbox> builder, float f) {
		...
		for (EnderDragonPart enderDragonPart : enderDragonEntity.getBodyParts()) {
			...
			EntityHitbox entityHitbox = new EntityHitbox(
				box.minX - enderDragonPart.getX(),
				box.minY - enderDragonPart.getY(),
				box.minZ - enderDragonPart.getZ(),
				box.maxX - enderDragonPart.getX(),
				box.maxY - enderDragonPart.getY(),
				box.maxZ - enderDragonPart.getZ(),
				(float)(d + MathHelper.lerp((double)f, enderDragonPart.lastRenderX, enderDragonPart.getX())),
				(float)(e + MathHelper.lerp((double)f, enderDragonPart.lastRenderY, enderDragonPart.getY())),
				(float)(g + MathHelper.lerp((double)f, enderDragonPart.lastRenderZ, enderDragonPart.getZ())),
				0.25F,
				1.0F,
				0.0F
			);
