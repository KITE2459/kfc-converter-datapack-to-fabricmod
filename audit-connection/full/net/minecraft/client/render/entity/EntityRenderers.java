...
public class EntityRenderers {
	...
	static {
		...
		register(EntityType.BIRCH_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.BIRCH_BOAT));
		register(EntityType.BIRCH_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.BIRCH_CHEST_BOAT));
		...
		register(EntityType.DONKEY, context -> new AbstractDonkeyEntityRenderer<>(context, AbstractDonkeyEntityRenderer.Type.DONKEY));
		...
		register(EntityType.JUNGLE_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.JUNGLE_BOAT));
		register(EntityType.JUNGLE_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.JUNGLE_CHEST_BOAT));
		...
		register(EntityType.MULE, context -> new AbstractDonkeyEntityRenderer<>(context, AbstractDonkeyEntityRenderer.Type.MULE));
		register(EntityType.OAK_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_BOAT));
		register(EntityType.OAK_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_CHEST_BOAT));
		...
		register(EntityType.SKELETON_HORSE, context -> new UndeadHorseEntityRenderer(context, UndeadHorseEntityRenderer.Type.SKELETON));
		...
		register(EntityType.SPRUCE_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.SPRUCE_BOAT));
		register(EntityType.SPRUCE_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.SPRUCE_CHEST_BOAT));
		register(
			EntityType.SQUID,
		...
		register(EntityType.ZOMBIE_HORSE, context -> new UndeadHorseEntityRenderer(context, UndeadHorseEntityRenderer.Type.ZOMBIE));
