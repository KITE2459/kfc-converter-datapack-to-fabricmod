	...
	private void renderPainting(
		...
		for (int u = 0; u < width; u++) {
			for (int v = 0; v < height; v++) {
				...
				float ab = paintingSprite.getFrameU((float)(d * (width - u)));
				float ac = paintingSprite.getFrameU((float)(d * (width - (u + 1))));
				float ad = paintingSprite.getFrameV((float)(e * (height - v)));
				float ae = paintingSprite.getFrameV((float)(e * (height - (v + 1))));
