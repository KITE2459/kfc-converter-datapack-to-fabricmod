...
public class BreezeAnimations {
	...
	public static final Animation LONG_JUMPING = Animation.Builder.create(0.5F)
		...
		.addBoneAnimation(
			...
			new Transformation(
				...
				new Keyframe(0.125F, AnimationHelper.createScalingVector(1.0, 1.3F, 1.0), Transformation.Interpolations.LINEAR),
		...
		.addBoneAnimation(
			...
			new Transformation(
				Transformation.Targets.SCALE,
				new Keyframe(0.0F, AnimationHelper.createScalingVector(1.0, 1.0, 1.0), Transformation.Interpolations.LINEAR),
				new Keyframe(0.125F, AnimationHelper.createScalingVector(1.0, 1.1F, 1.0), Transformation.Interpolations.LINEAR),
				new Keyframe(0.5F, AnimationHelper.createScalingVector(1.0, 1.0, 1.0), Transformation.Interpolations.LINEAR)
			)
		)
		.addBoneAnimation(
		...
		.build();
	public static final Animation INHALING = Animation.Builder.create(2.0F)
		.addBoneAnimation(
			"body",
			new Transformation(
				Transformation.Targets.MOVE_ORIGIN,
	...
	public static final Animation SLIDING = Animation.Builder.create(0.2F)
		...
		.build();
	public static final Animation SLIDING_BACK = Animation.Builder.create(0.1F)
		.addBoneAnimation(
			"body",
			new Transformation(
				Transformation.Targets.MOVE_ORIGIN,
