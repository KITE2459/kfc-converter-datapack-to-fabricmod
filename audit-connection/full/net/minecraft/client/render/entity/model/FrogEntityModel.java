...
public class FrogEntityModel extends EntityModel<FrogEntityRenderState> {
	...
	public void setAngles(FrogEntityRenderState frogEntityRenderState) {
		...
		if (frogEntityRenderState.insideWaterOrBubbleColumn) {
			this.animateWalking(FrogAnimations.SWIMMING, frogEntityRenderState.limbSwingAnimationProgress, frogEntityRenderState.limbSwingAmplitude, 1.0F, 2.5F);
		} else {
			this.animateWalking(FrogAnimations.WALKING, frogEntityRenderState.limbSwingAnimationProgress, frogEntityRenderState.limbSwingAmplitude, 1.5F, 2.5F);
		}
