...
public class QuadrupedEntityModel<T extends LivingEntityRenderState> extends EntityModel<T> {
	...
	public static ModelData getModelData(int stanceWidth, Dilation dilation) {
		...
		modelPartData.addChild(
			...
			ModelTransform.origin(0.0F, 18 - stanceWidth, -6.0F)
		);
		modelPartData.addChild(
		...
		modelPartData.addChild(EntityModelPartNames.RIGHT_HIND_LEG, modelPartBuilder, ModelTransform.origin(-3.0F, 24 - stanceWidth, 7.0F));
		modelPartData.addChild(EntityModelPartNames.LEFT_HIND_LEG, modelPartBuilder, ModelTransform.origin(3.0F, 24 - stanceWidth, 7.0F));
		modelPartData.addChild(EntityModelPartNames.RIGHT_FRONT_LEG, modelPartBuilder, ModelTransform.origin(-3.0F, 24 - stanceWidth, -5.0F));
		modelPartData.addChild(EntityModelPartNames.LEFT_FRONT_LEG, modelPartBuilder, ModelTransform.origin(3.0F, 24 - stanceWidth, -5.0F));
		return modelData;
	}
