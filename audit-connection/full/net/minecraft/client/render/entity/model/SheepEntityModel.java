...
public class SheepEntityModel extends QuadrupedEntityModel<SheepEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(
			EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -4.0F, -6.0F, 6.0F, 6.0F, 8.0F), ModelTransform.origin(0.0F, 6.0F, -8.0F)
		);
		modelPartData.addChild(
	...
	public void setAngles(SheepEntityRenderState sheepEntityRenderState) {
		...
		this.head.originY = this.head.originY + sheepEntityRenderState.neckAngle * 9.0F * sheepEntityRenderState.ageScale;
