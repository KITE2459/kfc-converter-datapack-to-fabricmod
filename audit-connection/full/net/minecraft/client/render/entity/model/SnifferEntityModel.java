...
public class SnifferEntityModel extends EntityModel<SnifferEntityRenderState> {
	...
	public void setAngles(SnifferEntityRenderState snifferEntityRenderState) {
		...
		if (snifferEntityRenderState.searching) {
			this.animateWalking(
				SnifferAnimations.SEARCHING, snifferEntityRenderState.limbSwingAnimationProgress, snifferEntityRenderState.limbSwingAmplitude, 9.0F, 100.0F
			);
		} else {
			this.animateWalking(
				SnifferAnimations.WALKING, snifferEntityRenderState.limbSwingAnimationProgress, snifferEntityRenderState.limbSwingAmplitude, 9.0F, 100.0F
			);
		}
