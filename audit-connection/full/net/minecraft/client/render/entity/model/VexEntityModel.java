...
public class VexEntityModel extends EntityModel<VexEntityRenderState> implements ModelWithArms {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData modelPartData2 = modelPartData.addChild(EntityModelPartNames.ROOT, ModelPartBuilder.create(), ModelTransform.origin(0.0F, -2.5F, 0.0F));
		...
		modelPartData3.addChild(
			...
			ModelTransform.origin(-1.75F, 0.25F, 0.0F)
		);
		modelPartData3.addChild(
		...
		modelPartData3.addChild(
			...
			ModelTransform.origin(0.5F, 1.0F, 1.0F)
		);
		modelPartData3.addChild(
	...
	public void setAngles(VexEntityRenderState vexEntityRenderState) {
		...
		this.head.yaw = vexEntityRenderState.relativeHeadYaw * (float) (Math.PI / 180.0);
