...
public class WindChargeEntityModel extends EntityModel<EntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData2.addChild(
			"wind_charge", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F)
		);
