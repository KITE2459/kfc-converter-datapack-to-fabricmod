...
public class BlockFamilies {
	...
	public static final BlockFamily DARK_OAK = register(Blocks.DARK_OAK_PLANKS)
		...
		.unlockCriterionName("has_planks")
		.build();
	public static final BlockFamily PALE_OAK = register(Blocks.PALE_OAK_PLANKS)
	...
	public static final BlockFamily MANGROVE = register(Blocks.MANGROVE_PLANKS)
		...
		.unlockCriterionName("has_planks")
		.build();
	public static final BlockFamily BAMBOO = register(Blocks.BAMBOO_PLANKS)
	...
	public static final BlockFamily TUFF_BRICK = register(Blocks.TUFF_BRICKS)
		...
		.build();
	public static final BlockFamily RESIN_BRICK = register(Blocks.RESIN_BRICKS)
