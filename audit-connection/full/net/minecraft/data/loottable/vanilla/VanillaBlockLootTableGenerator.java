						...
						.with(
							(LootPoolEntry.Builder<?>)this.applyExplosionDecay(
								...
								ItemEntry.builder(block)
									.apply(
										List.of(2, 3, 4),
										pickles -> SetCountLootFunction.builder(ConstantLootNumberProvider.create(pickles.intValue()))
											.conditionally(
							...
							AlternativeEntry.builder(
								AlternativeEntry.builder(
										...
										layers -> ItemEntry.builder(Items.SNOWBALL)
											.conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers)))
