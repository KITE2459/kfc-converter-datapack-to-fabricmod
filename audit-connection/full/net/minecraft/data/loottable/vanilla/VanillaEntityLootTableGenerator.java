					...
					LootPool.builder()
						...
						.with(
							ItemEntry.builder(Items.PEARLESCENT_FROGLIGHT)
								...
								.conditionally(this.killedByFrog(registryEntryLookup, registryEntryLookup2, FrogVariants.WARM))
						)
						.with(
							ItemEntry.builder(Items.VERDANT_FROGLIGHT)
								.apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))
								.conditionally(this.killedByFrog(registryEntryLookup, registryEntryLookup2, FrogVariants.COLD))
						)
						.with(
							ItemEntry.builder(Items.OCHRE_FROGLIGHT)
								.apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F)))
								.conditionally(this.killedByFrog(registryEntryLookup, registryEntryLookup2, FrogVariants.TEMPERATE))
						)
				)
		);
		this.register(
