...
public record VanillaGiftLootTableGenerator(RegistryWrapper.WrapperLookup registries) implements LootTableGenerator {
	...
	public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
		RegistryEntryLookup<ChickenVariant> registryEntryLookup = this.registries.getOrThrow(RegistryKeys.CHICKEN_VARIANT);
					...
					LootPool.builder()
						...
						.with(
							AlternativeEntry.builder(
													...
													ComponentsPredicate.Builder.create()
														.exact(
															ComponentMapPredicate.of(
																DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.TEMPERATE))
															)
														)
														.build()
												)
								...
								ItemEntry.builder(Items.BROWN_EGG)
									.conditionally(
										EntityPropertiesLootCondition.builder(
											LootContext.EntityTarget.THIS,
											EntityPredicate.Builder.create()
												.components(
													ComponentsPredicate.Builder.create()
														.exact(
															ComponentMapPredicate.of(
																DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.WARM))
															)
														)
														.build()
												)
								...
								ItemEntry.builder(Items.BLUE_EGG)
									.conditionally(
										EntityPropertiesLootCondition.builder(
											LootContext.EntityTarget.THIS,
											EntityPredicate.Builder.create()
												.components(
													ComponentsPredicate.Builder.create()
														.exact(
															ComponentMapPredicate.of(
																DataComponentTypes.CHICKEN_VARIANT, new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.COLD))
															)
														)
														.build()
												)
