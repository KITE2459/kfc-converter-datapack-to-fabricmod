...
public class VanillaRecipeGenerator extends RecipeGenerator {
	...
	protected void generate() {
		...
		this.createShaped(RecipeCategory.FOOD, Blocks.CAKE)
			...
			.pattern("BEB")
			.pattern("CCC")
			.criterion("has_egg", this.conditionsFromTag(ItemTags.EGGS))
			.offerTo(this.exporter);
		...
		this.createShaped(RecipeCategory.MISC, Blocks.CREAKING_HEART)
			.input('R', Items.RESIN_BLOCK)
			.input('L', Blocks.PALE_OAK_LOG)
			.pattern(" L ")
			.pattern(" R ")
			.pattern(" L ")
			.criterion("has_resin_block", this.conditionsFromItem(Items.RESIN_BLOCK))
			.offerTo(this.exporter);
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.LODESTONE)
			...
			.pattern("SSS")
			.criterion("has_iron_ingot", this.conditionsFromItem(Items.IRON_INGOT))
			.criterion("has_lodestone", this.conditionsFromItem(Items.LODESTONE))
			.offerTo(this.exporter);
		this.offerReversibleCompactingRecipesWithReverseRecipeGroup(
		...
		CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItem(Blocks.NETHERRACK), RecipeCategory.MISC, Items.NETHER_BRICK, 0.1F, 200)
			...
			.offerTo(this.exporter);
		CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItem(Items.RESIN_CLUMP), RecipeCategory.MISC, Items.RESIN_BRICK, 0.1F, 200)
			.criterion("has_resin_clump", this.conditionsFromItem(Blocks.RESIN_CLUMP))
			.offerTo(this.exporter);
		...
		CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItem(Blocks.COBBLED_DEEPSLATE), RecipeCategory.BUILDING_BLOCKS, Blocks.DEEPSLATE, 0.1F, 200)
			...
			.offerTo(this.exporter);
		CookingRecipeJsonBuilder.createSmelting(this.ingredientFromTag(ItemTags.LEAVES), RecipeCategory.MISC, Blocks.LEAF_LITTER, 0.1F, 200)
			.criterion("has_leaves", this.conditionsFromTag(ItemTags.LEAVES))
			.offerTo(this.exporter);
		...
		streamSmithingTemplates().forEach(template -> this.offerSmithingTrimRecipe(template.template(), template.patternId(), template.recipeId()));
	...
	public static Stream<VanillaRecipeGenerator.SmithingTemplate> streamSmithingTemplates() {
		return Stream.of(
			...
			.map(pair -> {
				...
				RegistryKey<Recipe<?>> registryKey2 = RegistryKey.of(RegistryKeys.RECIPE, Identifier.ofVanilla(getItemPath(item) + "_smithing_trim"));
