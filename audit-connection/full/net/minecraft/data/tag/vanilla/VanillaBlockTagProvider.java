...
public class VanillaBlockTagProvider extends ValueLookupTagProvider<Block> {
	...
	protected void configure(RegistryWrapper.WrapperLookup registries) {
		...
		this.getOrCreateTagBuilder(BlockTags.STONE_BUTTONS).add(Blocks.STONE_BUTTON, Blocks.POLISHED_BLACKSTONE_BUTTON);
		this.getOrCreateTagBuilder(BlockTags.BUTTONS).addTag(BlockTags.WOODEN_BUTTONS).addTag(BlockTags.STONE_BUTTONS);
		...
		this.getOrCreateTagBuilder(BlockTags.OAK_LOGS).add(Blocks.OAK_LOG, Blocks.OAK_WOOD, Blocks.STRIPPED_OAK_LOG, Blocks.STRIPPED_OAK_WOOD);
		this.getOrCreateTagBuilder(BlockTags.ACACIA_LOGS).add(Blocks.ACACIA_LOG, Blocks.ACACIA_WOOD, Blocks.STRIPPED_ACACIA_LOG, Blocks.STRIPPED_ACACIA_WOOD);
		...
		this.getOrCreateTagBuilder(BlockTags.SMALL_FLOWERS).add(blocks).add(Blocks.CLOSED_EYEBLOSSOM);
		...
		this.getOrCreateTagBuilder(BlockTags.SAND).add(Blocks.SAND, Blocks.RED_SAND, Blocks.SUSPICIOUS_SAND);
		this.getOrCreateTagBuilder(BlockTags.SMELTS_TO_GLASS).add(Blocks.SAND, Blocks.RED_SAND);
		this.getOrCreateTagBuilder(BlockTags.RAILS).add(Blocks.RAIL, Blocks.POWERED_RAIL, Blocks.DETECTOR_RAIL, Blocks.ACTIVATOR_RAIL);
		...
		this.getOrCreateTagBuilder(BlockTags.ICE).add(Blocks.ICE, Blocks.PACKED_ICE, Blocks.BLUE_ICE, Blocks.FROSTED_ICE);
		this.getOrCreateTagBuilder(BlockTags.VALID_SPAWN).add(Blocks.GRASS_BLOCK, Blocks.PODZOL);
		...
		this.getOrCreateTagBuilder(BlockTags.ALL_SIGNS).addTag(BlockTags.SIGNS).addTag(BlockTags.ALL_HANGING_SIGNS);
		...
		this.getOrCreateTagBuilder(BlockTags.FENCES).addTag(BlockTags.WOODEN_FENCES).add(Blocks.NETHER_BRICK_FENCE);
		...
		this.getOrCreateTagBuilder(BlockTags.DRAGON_TRANSPARENT).add(Blocks.LIGHT).addTag(BlockTags.FIRE);
		...
		this.getOrCreateTagBuilder(BlockTags.FLOWERS).addTag(BlockTags.SMALL_FLOWERS).add(blocks2);
		this.getOrCreateTagBuilder(BlockTags.BEE_ATTRACTIVE).add(blocks).add(blocks2);
		...
		this.getOrCreateTagBuilder(BlockTags.GOLD_ORES).add(Blocks.GOLD_ORE, Blocks.NETHER_GOLD_ORE, Blocks.DEEPSLATE_GOLD_ORE);
		this.getOrCreateTagBuilder(BlockTags.IRON_ORES).add(Blocks.IRON_ORE, Blocks.DEEPSLATE_IRON_ORE);
		this.getOrCreateTagBuilder(BlockTags.DIAMOND_ORES).add(Blocks.DIAMOND_ORE, Blocks.DEEPSLATE_DIAMOND_ORE);
		this.getOrCreateTagBuilder(BlockTags.REDSTONE_ORES).add(Blocks.REDSTONE_ORE, Blocks.DEEPSLATE_REDSTONE_ORE);
		this.getOrCreateTagBuilder(BlockTags.COAL_ORES).add(Blocks.COAL_ORE, Blocks.DEEPSLATE_COAL_ORE);
		this.getOrCreateTagBuilder(BlockTags.EMERALD_ORES).add(Blocks.EMERALD_ORE, Blocks.DEEPSLATE_EMERALD_ORE);
		...
		this.getOrCreateTagBuilder(BlockTags.EDIBLE_FOR_SHEEP).add(Blocks.SHORT_GRASS).add(Blocks.SHORT_DRY_GRASS).add(Blocks.TALL_DRY_GRASS).add(Blocks.FERN);
		...
		this.getOrCreateTagBuilder(BlockTags.SWORD_EFFICIENT)
			...
			.add(Blocks.PUMPKIN, Blocks.CARVED_PUMPKIN, Blocks.JACK_O_LANTERN, Blocks.MELON, Blocks.COCOA, Blocks.BIG_DRIPLEAF, Blocks.BIG_DRIPLEAF_STEM)
			.add(Blocks.CHORUS_PLANT, Blocks.CHORUS_FLOWER);
		this.getOrCreateTagBuilder(BlockTags.SWORD_INSTANTLY_MINES).add(Blocks.BAMBOO, Blocks.BAMBOO_SAPLING);
		...
		this.getOrCreateTagBuilder(BlockTags.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE).add(Blocks.ICE);
		...
		this.getOrCreateTagBuilder(BlockTags.WOLVES_SPAWNABLE_ON).add(Blocks.GRASS_BLOCK, Blocks.SNOW, Blocks.SNOW_BLOCK, Blocks.COARSE_DIRT, Blocks.PODZOL);
		this.getOrCreateTagBuilder(BlockTags.FROGS_SPAWNABLE_ON).add(Blocks.GRASS_BLOCK, Blocks.MUD, Blocks.MANGROVE_ROOTS, Blocks.MUDDY_MANGROVE_ROOTS);
		this.getOrCreateTagBuilder(BlockTags.BATS_SPAWNABLE_ON).addTag(BlockTags.BASE_STONE_OVERWORLD);
		this.getOrCreateTagBuilder(BlockTags.CAMELS_SPAWNABLE_ON).addTag(BlockTags.SAND);
		...
		this.getOrCreateTagBuilder(BlockTags.VIBRATION_RESONATORS).add(Blocks.AMETHYST_BLOCK);
		...
		this.getOrCreateTagBuilder(BlockTags.REPLACEABLE_BY_TREES)
			...
			.add(Blocks.WATER, Blocks.SEAGRASS, Blocks.TALL_SEAGRASS, Blocks.BUSH, Blocks.FIREFLY_BUSH)
			.add(Blocks.WARPED_ROOTS, Blocks.NETHER_SPROUTS, Blocks.CRIMSON_ROOTS, Blocks.LEAF_LITTER, Blocks.SHORT_DRY_GRASS, Blocks.TALL_DRY_GRASS);
		this.getOrCreateTagBuilder(BlockTags.REPLACEABLE_BY_MUSHROOMS)
			...
			.add(Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM_BLOCK)
			.add(
				Blocks.WARPED_ROOTS,
		...
		this.getOrCreateTagBuilder(BlockTags.INVALID_SPAWN_INSIDE).add(Blocks.END_PORTAL, Blocks.END_GATEWAY);
		this.getOrCreateTagBuilder(BlockTags.SAND).add(Blocks.SUSPICIOUS_SAND);
		this.getOrCreateTagBuilder(BlockTags.TRAIL_RUINS_REPLACEABLE).add(Blocks.GRAVEL);
		...
		registries.getOrThrow(RegistryKeys.BLOCK).withPredicateFilter(block -> block.getDefaultState().isReplaceable()).streamKeys().forEach(objectBuilder::add);
		...
		this.getOrCreateTagBuilder(BlockTags.PLAYS_AMBIENT_DESERT_BLOCK_SOUNDS).addTag(BlockTags.TERRACOTTA).add(Blocks.SAND, Blocks.RED_SAND);
