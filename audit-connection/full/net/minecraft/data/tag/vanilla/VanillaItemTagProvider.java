...
public class VanillaItemTagProvider extends ItemTagProvider {
	...
	protected void configure(RegistryWrapper.WrapperLookup registries) {
		...
		this.getOrCreateTagBuilder(ItemTags.EGGS).add(Items.EGG, Items.BLUE_EGG, Items.BROWN_EGG);
		...
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_LEATHER_ARMOR).add(Items.LEATHER);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_CHAIN_ARMOR).add(Items.IRON_INGOT);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_IRON_ARMOR).add(Items.IRON_INGOT);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_GOLD_ARMOR).add(Items.GOLD_INGOT);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_DIAMOND_ARMOR).add(Items.DIAMOND);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_NETHERITE_ARMOR).add(Items.NETHERITE_INGOT);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_TURTLE_HELMET).add(Items.TURTLE_SCUTE);
		this.getOrCreateTagBuilder(ItemTags.REPAIRS_WOLF_ARMOR).add(Items.ARMADILLO_SCUTE);
		...
		this.getOrCreateTagBuilder(ItemTags.BREAKS_DECORATED_POTS)
			...
			.add(Items.TRIDENT)
			.add(Items.MACE);
		this.getOrCreateTagBuilder(ItemTags.SKELETON_PREFERRED_WEAPONS).add(Items.BOW);
		this.getOrCreateTagBuilder(ItemTags.DROWNED_PREFERRED_WEAPONS).add(Items.TRIDENT);
		this.getOrCreateTagBuilder(ItemTags.PIGLIN_PREFERRED_WEAPONS).add(Items.CROSSBOW);
		this.getOrCreateTagBuilder(ItemTags.PILLAGER_PREFERRED_WEAPONS).add(Items.CROSSBOW);
		this.getOrCreateTagBuilder(ItemTags.WITHER_SKELETON_DISLIKED_WEAPONS).add(Items.BOW).add(Items.CROSSBOW);
		...
		this.getOrCreateTagBuilder(ItemTags.TRIM_MATERIALS)
			.add(
				registries.getOrThrow(RegistryKeys.ITEM)
					.streamEntries()
					.filter(reference -> ((Item)reference.value()).getComponents().contains(DataComponentTypes.PROVIDES_TRIM_MATERIAL))
		...
		this.getOrCreateTagBuilder(ItemTags.BOOK_CLONING_TARGET).add(Items.WRITABLE_BOOK);
		...
		this.getOrCreateTagBuilder(ItemTags.GAZE_DISGUISE_EQUIPMENT).add(Items.CARVED_PUMPKIN);
	}
}
