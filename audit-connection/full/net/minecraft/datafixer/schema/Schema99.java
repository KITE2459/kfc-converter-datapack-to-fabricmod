...
public class Schema99 extends Schema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(
			...
			(Supplier<TypeTemplate>)(() -> DSL.optionalFields(
				"DisplayTile", TypeReferences.BLOCK_NAME.in(schema), "LastOutput", TypeReferences.TEXT_COMPONENT.in(schema)
			))
		);
		...
		schema.register(map, "Enderman", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(schema))));
	...
	public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
		...
		schema.register(map, "Sign", (Supplier<TypeTemplate>)(() -> method_66194(schema)));
		...
		schema.register(map, "Control", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("LastOutput", TypeReferences.TEXT_COMPONENT.in(schema))));
		schema.registerSimple(map, "Beacon");
		schema.register(map, "Skull", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("custom_name", TypeReferences.TEXT_COMPONENT.in(schema))));
		...
		schema.register(map, "Banner", (Supplier<TypeTemplate>)(() -> DSL.optionalFields("CustomName", TypeReferences.TEXT_COMPONENT.in(schema))));
	...
	public static TypeTemplate method_66194(Schema schema) {
		return DSL.optionalFields(
			Pair.of("Text1", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("Text2", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("Text3", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("Text4", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("FilteredText1", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("FilteredText2", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("FilteredText3", TypeReferences.TEXT_COMPONENT.in(schema)),
			Pair.of("FilteredText4", TypeReferences.TEXT_COMPONENT.in(schema))
		);
	}
	...
	public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
		schema.registerType(
			...
			() -> DSL.optionalFields("CustomBossEvents", DSL.compoundList(DSL.optionalFields("Name", TypeReferences.TEXT_COMPONENT.in(schema))))
		);
		schema.registerType(
			false,
		...
		schema.registerType(
			...
			() -> DSL.and(
				...
				DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", DSL.string(), entityTypes))
			)
		);
		schema.registerType(
			true,
			...
			() -> DSL.hook(
				DSL.optionalFields("id", DSL.or(DSL.constType(DSL.intType()), TypeReferences.ITEM_NAME.in(schema)), "tag", method_66195(schema)),
				field_5747,
		...
		schema.registerType(
			...
			() -> DSL.optionalFields("banners", DSL.list(DSL.optionalFields("Name", TypeReferences.TEXT_COMPONENT.in(schema))))
		);
	...
	public static TypeTemplate method_66195(Schema schema) {
		return DSL.optionalFields(
			...
			Pair.of("pages", DSL.list(TypeReferences.TEXT_COMPONENT.in(schema))),
			Pair.of("filtered_pages", DSL.compoundList(TypeReferences.TEXT_COMPONENT.in(schema))),
			Pair.of("display", DSL.optionalFields("Name", TypeReferences.TEXT_COMPONENT.in(schema), "Lore", DSL.list(TypeReferences.TEXT_COMPONENT.in(schema))))
		);
	}
