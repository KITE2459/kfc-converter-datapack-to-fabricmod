...
public class Brain<E extends LivingEntity> {
		...
		mutableObject.setValue(
			(new MapCodec<Brain<E>>() {
					...
					public <T> DataResult<Brain<E>> decode(DynamicOps<T> ops, MapLike<T> map) {
						...
						ImmutableList<Brain.MemoryEntry<?>> immutableList = (ImmutableList<Brain.MemoryEntry<?>>)mutableObjectx.getValue()
	...
	public void setTaskList(
		Activity activity, int begin, ImmutableList<? extends Task<? super E>> tasks, Set<Pair<MemoryModuleType<?>, MemoryModuleState>> requiredMemories
	) {
