...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<List<PlayerEntity>> NEAREST_VISIBLE_TARGETABLE_PLAYERS = register("nearest_visible_targetable_players");
	...
	public static final MemoryModuleType<Unit> BREEZE_SHOOT_RECOVER = register("breeze_shoot_recover", Unit.CODEC);
