...
public class EndCrystalEntity extends Entity {
	...
	protected void writeCustomDataToNbt(NbtCompound nbt) {
		nbt.putNullable("beam_target", BlockPos.CODEC, this.getBeamTarget());
		nbt.putBoolean("ShowBottom", this.shouldShowBottom());
	}

	@Override
	protected void readCustomDataFromNbt(NbtCompound nbt) {
		this.setBeamTarget((BlockPos)nbt.get("beam_target", BlockPos.CODEC).orElse(null));
		this.setShowBottom(nbt.getBoolean("ShowBottom", true));
	}
