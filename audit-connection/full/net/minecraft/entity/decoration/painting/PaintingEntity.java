...
public class PaintingEntity extends AbstractDecorationEntity {
	...
	public void writeCustomDataToNbt(NbtCompound nbt) {
		nbt.put("facing", Direction.HORIZONTAL_QUARTER_TURNS_CODEC, this.facing);
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		this.facing = (Direction)nbt.get("facing", Direction.HORIZONTAL_QUARTER_TURNS_CODEC).orElse(Direction.SOUTH);
		super.readCustomDataFromNbt(nbt);
		this.setFacing(this.facing);
		Variants.readVariantFromNbt(nbt, this.getRegistryManager(), RegistryKeys.PAINTING_VARIANT).ifPresent(this::setVariant);
	}
