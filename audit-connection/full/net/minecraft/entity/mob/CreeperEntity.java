...
public class CreeperEntity extends HostileEntity {
	...
	public void writeCustomDataToNbt(NbtCompound nbt) {
		...
		nbt.putBoolean("powered", this.isCharged());
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.dataTracker.set(CHARGED, nbt.getBoolean("powered", false));
		this.fuseTime = nbt.getShort("Fuse", (short)30);
		this.explosionRadius = nbt.getByte("ExplosionRadius", (byte)3);
