...
public class GhastEntity extends FlyingEntity implements Monster {
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.fireballStrength = nbt.getByte("ExplosionPower", (byte)1);
	}
	...
	static class FlyRandomlyGoal extends Goal {
		...
		public void start() {
			...
			double e = this.ghast.getY() + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
			double f = this.ghast.getZ() + (random.nextFloat() * 2.0F - 1.0F) * 16.0F;
