...
public class HoglinEntity extends AnimalEntity implements Monster, Hoglin {
	...
	public void writeCustomDataToNbt(NbtCompound nbt) {
		...
		nbt.putBoolean("IsImmuneToZombification", this.isImmuneToZombification());
		nbt.putInt("TimeInOverworld", this.timeInOverworld);
		nbt.putBoolean("CannotBeHunted", this.cannotBeHunted);
	}

	@Override
	public void readCustomDataFromNbt(NbtCompound nbt) {
		super.readCustomDataFromNbt(nbt);
		this.setImmuneToZombification(nbt.getBoolean("IsImmuneToZombification", false));
		this.timeInOverworld = nbt.getInt("TimeInOverworld", 0);
		this.setCannotBeHunted(nbt.getBoolean("CannotBeHunted", false));
	}
