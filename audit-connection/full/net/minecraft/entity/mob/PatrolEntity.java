...
public abstract class PatrolEntity extends HostileEntity {
	...
	public void writeCustomDataToNbt(NbtCompound nbt) {
		...
		nbt.putNullable("patrol_target", BlockPos.CODEC, this.patrolTarget);
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.patrolTarget = (BlockPos)nbt.get("patrol_target", BlockPos.CODEC).orElse(null);
		this.patrolLeader = nbt.getBoolean("PatrolLeader", false);
		this.patrolling = nbt.getBoolean("Patrolling", false);
	}
	...
	public static class PatrolGoal<T extends PatrolEntity> extends Goal {
		...
		private boolean wander() {
			...
			return this.entity.getNavigation().startMovingTo(blockPos.getX(), blockPos.getY(), blockPos.getZ(), this.leaderSpeed);
		}
	}
}
