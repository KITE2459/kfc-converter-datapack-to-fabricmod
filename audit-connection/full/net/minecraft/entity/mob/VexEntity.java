...
public class VexEntity extends HostileEntity implements Ownable {
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.bounds = (BlockPos)nbt.get("bound_pos", BlockPos.CODEC).orElse(null);
		nbt.getInt("life_ticks").ifPresentOrElse(this::setLifeTicks, () -> this.alive = false);
	}
	...
	public void writeCustomDataToNbt(NbtCompound nbt) {
		...
		nbt.putNullable("bound_pos", BlockPos.CODEC, this.bounds);
		if (this.alive) {
			nbt.putInt("life_ticks", this.lifeTicks);
		}
	}
