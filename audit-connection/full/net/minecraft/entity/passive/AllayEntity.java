...
public class AllayEntity extends PathAwareEntity implements InventoryOwner, Vibrations {
	...
	public void setDancing(boolean dancing) {
		if (!this.getWorld().isClient && this.canActVoluntarily() && (!dancing || !this.isPanicking())) {
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.setDuplicationCooldown(nbt.getInt("DuplicationCooldown", 0));
	}
	...
	private void tickDuplicationCooldown() {
		if (!this.getWorld().isClient() && this.duplicationCooldown > 0L) {
