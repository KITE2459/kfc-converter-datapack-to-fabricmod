 ...
 *   <td><ul>
 *     <li>{@link net.minecraft.entity.ai.brain.task.UpdateLookControlTask}</li>
 *     <li>{@link net.minecraft.entity.ai.brain.task.MoveToTargetTask}</li>
 *     <li>{@link net.minecraft.entity.ai.brain.task.PlayDeadTimerTask}</li>
 *     <li>{@link net.minecraft.entity.ai.brain.task.TickCooldownTask}</li>
 *   </ul></td>
 * </tr>
 * <tr>
 ...
 *     <li>{@link net.minecraft.entity.ai.brain.task.WalkTowardsClosestAdultTask}</li>
