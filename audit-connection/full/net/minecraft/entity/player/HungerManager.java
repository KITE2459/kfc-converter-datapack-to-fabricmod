...
public class HungerManager {
	...
	public void readNbt(NbtCompound nbt) {
		this.foodLevel = nbt.getInt("foodLevel", 20);
		this.foodTickTimer = nbt.getInt("foodTickTimer", 0);
		this.saturationLevel = nbt.getFloat("foodSaturationLevel", 5.0F);
		this.exhaustion = nbt.getFloat("foodExhaustionLevel", 0.0F);
	}
