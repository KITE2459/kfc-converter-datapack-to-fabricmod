...
public class FireballEntity extends AbstractFireballEntity {
	...
	protected void onCollision(HitResult hitResult) {
		...
		if (this.getWorld() instanceof ServerWorld serverWorld) {
			...
			this.getWorld().createExplosion(this, this.getX(), this.getY(), this.getZ(), this.explosionPower, bl, World.ExplosionSourceType.MOB);
			this.discard();
		}
	}
	...
	public void readCustomDataFromNbt(NbtCompound nbt) {
		...
		this.explosionPower = nbt.getByte("ExplosionPower", (byte)1);
	}
}
