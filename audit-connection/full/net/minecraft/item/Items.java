...
public class Items {
	...
	public static final Item ARMADILLO_SPAWN_EGG = register("armadillo_spawn_egg", settings -> new SpawnEggItem(EntityType.ARMADILLO, settings));
	public static final Item ALLAY_SPAWN_EGG = register("allay_spawn_egg", settings -> new SpawnEggItem(EntityType.ALLAY, settings));
	public static final Item AXOLOTL_SPAWN_EGG = register("axolotl_spawn_egg", settings -> new SpawnEggItem(EntityType.AXOLOTL, settings));
	public static final Item BAT_SPAWN_EGG = register("bat_spawn_egg", settings -> new SpawnEggItem(EntityType.BAT, settings));
	public static final Item BEE_SPAWN_EGG = register("bee_spawn_egg", settings -> new SpawnEggItem(EntityType.BEE, settings));
	public static final Item BLAZE_SPAWN_EGG = register("blaze_spawn_egg", settings -> new SpawnEggItem(EntityType.BLAZE, settings));
	public static final Item BOGGED_SPAWN_EGG = register("bogged_spawn_egg", settings -> new SpawnEggItem(EntityType.BOGGED, settings));
	public static final Item BREEZE_SPAWN_EGG = register("breeze_spawn_egg", settings -> new SpawnEggItem(EntityType.BREEZE, settings));
	public static final Item CAT_SPAWN_EGG = register("cat_spawn_egg", settings -> new SpawnEggItem(EntityType.CAT, settings));
	public static final Item CAMEL_SPAWN_EGG = register("camel_spawn_egg", settings -> new SpawnEggItem(EntityType.CAMEL, settings));
	public static final Item CAVE_SPIDER_SPAWN_EGG = register("cave_spider_spawn_egg", settings -> new SpawnEggItem(EntityType.CAVE_SPIDER, settings));
	public static final Item CHICKEN_SPAWN_EGG = register("chicken_spawn_egg", settings -> new SpawnEggItem(EntityType.CHICKEN, settings));
	public static final Item COD_SPAWN_EGG = register("cod_spawn_egg", settings -> new SpawnEggItem(EntityType.COD, settings));
	public static final Item COW_SPAWN_EGG = register("cow_spawn_egg", settings -> new SpawnEggItem(EntityType.COW, settings));
	public static final Item CREEPER_SPAWN_EGG = register("creeper_spawn_egg", settings -> new SpawnEggItem(EntityType.CREEPER, settings));
	public static final Item DOLPHIN_SPAWN_EGG = register("dolphin_spawn_egg", settings -> new SpawnEggItem(EntityType.DOLPHIN, settings));
	public static final Item DONKEY_SPAWN_EGG = register("donkey_spawn_egg", settings -> new SpawnEggItem(EntityType.DONKEY, settings));
	public static final Item DROWNED_SPAWN_EGG = register("drowned_spawn_egg", settings -> new SpawnEggItem(EntityType.DROWNED, settings));
	public static final Item ELDER_GUARDIAN_SPAWN_EGG = register("elder_guardian_spawn_egg", settings -> new SpawnEggItem(EntityType.ELDER_GUARDIAN, settings));
	public static final Item ENDER_DRAGON_SPAWN_EGG = register("ender_dragon_spawn_egg", settings -> new SpawnEggItem(EntityType.ENDER_DRAGON, settings));
	public static final Item ENDERMAN_SPAWN_EGG = register("enderman_spawn_egg", settings -> new SpawnEggItem(EntityType.ENDERMAN, settings));
	public static final Item ENDERMITE_SPAWN_EGG = register("endermite_spawn_egg", settings -> new SpawnEggItem(EntityType.ENDERMITE, settings));
	public static final Item EVOKER_SPAWN_EGG = register("evoker_spawn_egg", settings -> new SpawnEggItem(EntityType.EVOKER, settings));
	public static final Item FOX_SPAWN_EGG = register("fox_spawn_egg", settings -> new SpawnEggItem(EntityType.FOX, settings));
	public static final Item FROG_SPAWN_EGG = register("frog_spawn_egg", settings -> new SpawnEggItem(EntityType.FROG, settings));
	public static final Item GHAST_SPAWN_EGG = register("ghast_spawn_egg", settings -> new SpawnEggItem(EntityType.GHAST, settings));
	public static final Item GLOW_SQUID_SPAWN_EGG = register("glow_squid_spawn_egg", settings -> new SpawnEggItem(EntityType.GLOW_SQUID, settings));
	public static final Item GOAT_SPAWN_EGG = register("goat_spawn_egg", settings -> new SpawnEggItem(EntityType.GOAT, settings));
	public static final Item GUARDIAN_SPAWN_EGG = register("guardian_spawn_egg", settings -> new SpawnEggItem(EntityType.GUARDIAN, settings));
	public static final Item HOGLIN_SPAWN_EGG = register("hoglin_spawn_egg", settings -> new SpawnEggItem(EntityType.HOGLIN, settings));
	public static final Item HORSE_SPAWN_EGG = register("horse_spawn_egg", settings -> new SpawnEggItem(EntityType.HORSE, settings));
	public static final Item HUSK_SPAWN_EGG = register("husk_spawn_egg", settings -> new SpawnEggItem(EntityType.HUSK, settings));
	public static final Item IRON_GOLEM_SPAWN_EGG = register("iron_golem_spawn_egg", settings -> new SpawnEggItem(EntityType.IRON_GOLEM, settings));
	public static final Item LLAMA_SPAWN_EGG = register("llama_spawn_egg", settings -> new SpawnEggItem(EntityType.LLAMA, settings));
	public static final Item MAGMA_CUBE_SPAWN_EGG = register("magma_cube_spawn_egg", settings -> new SpawnEggItem(EntityType.MAGMA_CUBE, settings));
	public static final Item MOOSHROOM_SPAWN_EGG = register("mooshroom_spawn_egg", settings -> new SpawnEggItem(EntityType.MOOSHROOM, settings));
	public static final Item MULE_SPAWN_EGG = register("mule_spawn_egg", settings -> new SpawnEggItem(EntityType.MULE, settings));
	public static final Item OCELOT_SPAWN_EGG = register("ocelot_spawn_egg", settings -> new SpawnEggItem(EntityType.OCELOT, settings));
	public static final Item PANDA_SPAWN_EGG = register("panda_spawn_egg", settings -> new SpawnEggItem(EntityType.PANDA, settings));
	public static final Item PARROT_SPAWN_EGG = register("parrot_spawn_egg", settings -> new SpawnEggItem(EntityType.PARROT, settings));
	public static final Item PHANTOM_SPAWN_EGG = register("phantom_spawn_egg", settings -> new SpawnEggItem(EntityType.PHANTOM, settings));
	public static final Item PIG_SPAWN_EGG = register("pig_spawn_egg", settings -> new SpawnEggItem(EntityType.PIG, settings));
	public static final Item PIGLIN_SPAWN_EGG = register("piglin_spawn_egg", settings -> new SpawnEggItem(EntityType.PIGLIN, settings));
	public static final Item PIGLIN_BRUTE_SPAWN_EGG = register("piglin_brute_spawn_egg", settings -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, settings));
	public static final Item PILLAGER_SPAWN_EGG = register("pillager_spawn_egg", settings -> new SpawnEggItem(EntityType.PILLAGER, settings));
	public static final Item POLAR_BEAR_SPAWN_EGG = register("polar_bear_spawn_egg", settings -> new SpawnEggItem(EntityType.POLAR_BEAR, settings));
	public static final Item PUFFERFISH_SPAWN_EGG = register("pufferfish_spawn_egg", settings -> new SpawnEggItem(EntityType.PUFFERFISH, settings));
	public static final Item RABBIT_SPAWN_EGG = register("rabbit_spawn_egg", settings -> new SpawnEggItem(EntityType.RABBIT, settings));
	public static final Item RAVAGER_SPAWN_EGG = register("ravager_spawn_egg", settings -> new SpawnEggItem(EntityType.RAVAGER, settings));
	public static final Item SALMON_SPAWN_EGG = register("salmon_spawn_egg", settings -> new SpawnEggItem(EntityType.SALMON, settings));
	public static final Item SHEEP_SPAWN_EGG = register("sheep_spawn_egg", settings -> new SpawnEggItem(EntityType.SHEEP, settings));
	public static final Item SHULKER_SPAWN_EGG = register("shulker_spawn_egg", settings -> new SpawnEggItem(EntityType.SHULKER, settings));
	public static final Item SILVERFISH_SPAWN_EGG = register("silverfish_spawn_egg", settings -> new SpawnEggItem(EntityType.SILVERFISH, settings));
	public static final Item SKELETON_SPAWN_EGG = register("skeleton_spawn_egg", settings -> new SpawnEggItem(EntityType.SKELETON, settings));
	public static final Item SKELETON_HORSE_SPAWN_EGG = register("skeleton_horse_spawn_egg", settings -> new SpawnEggItem(EntityType.SKELETON_HORSE, settings));
	public static final Item SLIME_SPAWN_EGG = register("slime_spawn_egg", settings -> new SpawnEggItem(EntityType.SLIME, settings));
	public static final Item SNIFFER_SPAWN_EGG = register("sniffer_spawn_egg", settings -> new SpawnEggItem(EntityType.SNIFFER, settings));
	public static final Item SNOW_GOLEM_SPAWN_EGG = register("snow_golem_spawn_egg", settings -> new SpawnEggItem(EntityType.SNOW_GOLEM, settings));
	public static final Item SPIDER_SPAWN_EGG = register("spider_spawn_egg", settings -> new SpawnEggItem(EntityType.SPIDER, settings));
	public static final Item SQUID_SPAWN_EGG = register("squid_spawn_egg", settings -> new SpawnEggItem(EntityType.SQUID, settings));
	public static final Item STRAY_SPAWN_EGG = register("stray_spawn_egg", settings -> new SpawnEggItem(EntityType.STRAY, settings));
	public static final Item STRIDER_SPAWN_EGG = register("strider_spawn_egg", settings -> new SpawnEggItem(EntityType.STRIDER, settings));
	public static final Item TADPOLE_SPAWN_EGG = register("tadpole_spawn_egg", settings -> new SpawnEggItem(EntityType.TADPOLE, settings));
	public static final Item TRADER_LLAMA_SPAWN_EGG = register("trader_llama_spawn_egg", settings -> new SpawnEggItem(EntityType.TRADER_LLAMA, settings));
	public static final Item TROPICAL_FISH_SPAWN_EGG = register("tropical_fish_spawn_egg", settings -> new SpawnEggItem(EntityType.TROPICAL_FISH, settings));
	public static final Item TURTLE_SPAWN_EGG = register("turtle_spawn_egg", settings -> new SpawnEggItem(EntityType.TURTLE, settings));
	public static final Item VEX_SPAWN_EGG = register("vex_spawn_egg", settings -> new SpawnEggItem(EntityType.VEX, settings));
	public static final Item VILLAGER_SPAWN_EGG = register("villager_spawn_egg", settings -> new SpawnEggItem(EntityType.VILLAGER, settings));
	public static final Item VINDICATOR_SPAWN_EGG = register("vindicator_spawn_egg", settings -> new SpawnEggItem(EntityType.VINDICATOR, settings));
	public static final Item WANDERING_TRADER_SPAWN_EGG = register(
		"wandering_trader_spawn_egg", settings -> new SpawnEggItem(EntityType.WANDERING_TRADER, settings)
	);
	public static final Item WARDEN_SPAWN_EGG = register("warden_spawn_egg", settings -> new SpawnEggItem(EntityType.WARDEN, settings));
	public static final Item WITCH_SPAWN_EGG = register("witch_spawn_egg", settings -> new SpawnEggItem(EntityType.WITCH, settings));
	public static final Item WITHER_SPAWN_EGG = register("wither_spawn_egg", settings -> new SpawnEggItem(EntityType.WITHER, settings));
	public static final Item WITHER_SKELETON_SPAWN_EGG = register("wither_skeleton_spawn_egg", settings -> new SpawnEggItem(EntityType.WITHER_SKELETON, settings));
	public static final Item WOLF_SPAWN_EGG = register("wolf_spawn_egg", settings -> new SpawnEggItem(EntityType.WOLF, settings));
	public static final Item ZOGLIN_SPAWN_EGG = register("zoglin_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOGLIN, settings));
	public static final Item CREAKING_SPAWN_EGG = register("creaking_spawn_egg", settings -> new SpawnEggItem(EntityType.CREAKING, settings));
	public static final Item ZOMBIE_SPAWN_EGG = register("zombie_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOMBIE, settings));
	public static final Item ZOMBIE_HORSE_SPAWN_EGG = register("zombie_horse_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOMBIE_HORSE, settings));
	public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = register("zombie_villager_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, settings));
	public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = register(
		"zombified_piglin_spawn_egg", settings -> new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, settings)
	);
