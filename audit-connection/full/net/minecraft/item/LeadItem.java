...
public class LeadItem extends Item {
	...
	public static List<Leashable> collectLeashablesAround(World world, BlockPos pos, Predicate<Leashable> predicate) {
		...
		int j = pos.getY();
		int k = pos.getZ();
		Box box = new Box(i - 7.0, j - 7.0, k - 7.0, i + 7.0, j + 7.0, k + 7.0);
		return world.getEntitiesByClass(Entity.class, box, entity -> entity instanceof Leashable leashable && predicate.test(leashable))
			.stream()
