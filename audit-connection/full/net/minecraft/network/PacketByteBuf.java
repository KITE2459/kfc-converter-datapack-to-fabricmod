...
public class PacketByteBuf extends ByteBuf {
	...
	public BlockHitResult readBlockHitResult() {
		...
		return new BlockHitResult(new Vec3d((double)blockPos.getX() + f, (double)blockPos.getY() + g, (double)blockPos.getZ() + h), direction, blockPos, bl, bl2);
	}
	...
	public void writeBlockHitResult(BlockHitResult hitResult) {
		...
		this.writeFloat((float)(vec3d.x - blockPos.getX()));
		this.writeFloat((float)(vec3d.y - blockPos.getY()));
		this.writeFloat((float)(vec3d.z - blockPos.getZ()));
