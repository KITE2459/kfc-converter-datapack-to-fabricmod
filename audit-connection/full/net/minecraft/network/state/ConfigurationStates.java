...
public class ConfigurationStates {
	public static final NetworkStateFactory<ServerConfigurationPacketListener, PacketByteBuf> C2S_FACTORY = NetworkStateBuilder.c2s(
	...
	public static final NetworkStateFactory<ClientConfigurationPacketListener, PacketByteBuf> S2C_FACTORY = NetworkStateBuilder.s2c(
		NetworkPhase.CONFIGURATION,
