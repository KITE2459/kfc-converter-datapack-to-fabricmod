...
public class PlayStateFactories {
	public static final PacketCodecModifier<RegistryByteBuf, CreativeInventoryActionC2SPacket, PlayStateFactories.PacketCodecModifierContext> CREATIVE_INVENTORY_ACTION_C2S_MODIFIER = (packetCodec, context) -> new PacketCodec<RegistryByteBuf, CreativeInventoryActionC2SPacket>(
		...
		public CreativeInventoryActionC2SPacket decode(RegistryByteBuf registryByteBuf) {
			if (!context.isInCreativeMode()) {
				...
				return (CreativeInventoryActionC2SPacket)packetCodec.decode(registryByteBuf);
			}
		}
		...
		public void encode(RegistryByteBuf registryByteBuf, CreativeInventoryActionC2SPacket creativeInventoryActionC2SPacket) {
			if (!context.isInCreativeMode()) {
				...
				packetCodec.encode(registryByteBuf, creativeInventoryActionC2SPacket);
			}
		}
	};
	public static final ContextAwareNetworkStateFactory<ServerPlayPacketListener, RegistryByteBuf, PlayStateFactories.PacketCodecModifierContext> C2S = NetworkStateBuilder.contextAwareC2S(
		NetworkPhase.PLAY,
		builder -> builder.add(PlayPackets.ACCEPT_TELEPORTATION, TeleportConfirmC2SPacket.CODEC)
			...
			.add(PlayPackets.SET_CREATIVE_MODE_SLOT, CreativeInventoryActionC2SPacket.CODEC, CREATIVE_INVENTORY_ACTION_C2S_MODIFIER)
