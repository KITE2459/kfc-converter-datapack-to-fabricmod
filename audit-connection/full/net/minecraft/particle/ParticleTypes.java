...
public class ParticleTypes {
	...
	public static final ParticleType<EntityEffectParticleEffect> TINTED_LEAVES = register(
		"tinted_leaves", false, EntityEffectParticleEffect::createCodec, EntityEffectParticleEffect::createPacketCodec
	);
