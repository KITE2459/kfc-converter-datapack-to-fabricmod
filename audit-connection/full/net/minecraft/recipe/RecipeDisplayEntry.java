...
public record RecipeDisplayEntry(
	...
	public boolean isCraftable(RecipeFinder finder) {
		return this.craftingRequirements.isEmpty()
			? false
			: finder.isCraftable((List<? extends RecipeMatcher.RawIngredient<RegistryEntry<Item>>>)this.craftingRequirements.get(), null);
	}
}
