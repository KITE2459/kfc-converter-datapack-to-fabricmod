...
public final class RecipeBookOptions {
	...
	public static RecipeBookOptions fromNbt(NbtCompound nbt) {
		...
		CATEGORY_OPTION_NAMES.forEach((category, pair) -> {
			boolean bl = nbt.getBoolean((String)pair.getFirst(), RecipeBookOptions.CategoryOption.DEFAULT.guiOpen());
			boolean bl2 = nbt.getBoolean((String)pair.getSecond(), RecipeBookOptions.CategoryOption.DEFAULT.filteringCraftable());
			if (bl || bl2) {
