...
public class Registries {
	...
	public static final DefaultedRegistry<VillagerType> VILLAGER_TYPE = create(RegistryKeys.VILLAGER_TYPE, "plains", VillagerType::registerAndGetDefault);
	...
	public static final Registry<ChunkTicketType> TICKET_TYPE = create(RegistryKeys.TICKET_TYPE, registry -> ChunkTicketType.UNKNOWN);
	public static final Registry<MapCodec<? extends TestEnvironmentDefinition>> TEST_ENVIRONMENT_DEFINITION_TYPE = create(
	...
	public static final Registry<Consumer<TestContext>> TEST_FUNCTION = create(RegistryKeys.TEST_FUNCTION, BuiltinTestFunctions::registerAndGetDefault);
