 ...
 * dynamic registry manager, then call the {@link DynamicRegistryManager#getOrThrow} method.</li>
 * </ul>
 * 
 ...
 * <ul>
 * <li>{@link #getOrThrow(RegistryKey)} or {@link #getOptional(RegistryKey)} for getting the registry entry
 * from the key.</li>
 * <li>{@link #getOptionalValue(Identifier)} or {@link #getOptionalValue(RegistryKey)} for getting the registered
 ...
 * <li>{@link #getOptional(TagKey)} and {@link #iterateEntries} for getting the contents of a tag,</li>
