							...
							CommandManager.argument("id", IdentifierArgumentType.identifier())
								.then(
									CommandManager.argument("name", TextArgumentType.text(registryAccess))
										.executes(
											context -> addBossBar(context.getSource(), IdentifierArgumentType.getIdentifier(context, "id"), TextArgumentType.parseTextArgument(context, "name"))
										)
								)
						)
				)
							...
							CommandManager.argument("id", IdentifierArgumentType.identifier())
								...
								.then(
									CommandManager.literal("name")
										.then(
											CommandManager.argument("name", TextArgumentType.text(registryAccess))
												.executes(context -> setName(context.getSource(), getBossBar(context), TextArgumentType.parseTextArgument(context, "name")))
										)
								)
								.then(
