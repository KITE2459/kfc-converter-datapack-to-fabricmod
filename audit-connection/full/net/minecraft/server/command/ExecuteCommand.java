					...
					CommandManager.literal("rotated")
						.then(
							CommandManager.argument("rot", RotationArgumentType.rotation())
								.redirect(
									literalCommandNode, context -> context.getSource().withRotation(RotationArgumentType.getRotation(context, "rot").getRotation(context.getSource()))
								)
						)
						.then(CommandManager.literal("as").then(CommandManager.argument("targets", EntityArgumentType.entities()).fork(literalCommandNode, context -> {
							List<ServerCommandSource> list = Lists.<ServerCommandSource>newArrayList();
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												result -> NbtInt.of((int)(result * DoubleArgumentType.getDouble(context, "scale"))),
												requestResult
											)
										)
								)
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												objectType.getObject(context),
												NbtPathArgumentType.getNbtPath(context, "path"),
												result -> NbtFloat.of((float)(result * DoubleArgumentType.getDouble(context, "scale"))),
												requestResult
											)
										)
								)
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												objectType.getObject(context),
												NbtPathArgumentType.getNbtPath(context, "path"),
												result -> NbtShort.of((short)(result * DoubleArgumentType.getDouble(context, "scale"))),
												requestResult
											)
										)
								)
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												objectType.getObject(context),
												NbtPathArgumentType.getNbtPath(context, "path"),
												result -> NbtLong.of((long)(result * DoubleArgumentType.getDouble(context, "scale"))),
												requestResult
											)
										)
								)
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												objectType.getObject(context),
												NbtPathArgumentType.getNbtPath(context, "path"),
												result -> NbtDouble.of(result * DoubleArgumentType.getDouble(context, "scale")),
												requestResult
											)
										)
								)
									...
									CommandManager.argument("scale", DoubleArgumentType.doubleArg())
										.redirect(
											...
											context -> executeStoreData(
												...
												objectType.getObject(context),
												NbtPathArgumentType.getNbtPath(context, "path"),
												result -> NbtByte.of((byte)(result * DoubleArgumentType.getDouble(context, "scale"))),
												requestResult
											)
										)
								)
