			...
			.accept(
				new GameRules.Visitor() {
					...
					public <T extends GameRules.Rule<T>> void visit(GameRules.Key<T> key, GameRules.Type<T> type) {
						LiteralArgumentBuilder<ServerCommandSource> literalArgumentBuilderx = CommandManager.literal(key.getName());
						literalArgumentBuilder.then(
							literalArgumentBuilderx.executes(context -> GameRuleCommand.executeQuery(context.getSource(), key))
