...
public class BlockSoundGroup {
	...
	public static final BlockSoundGroup CACTUS_FLOWER = new BlockSoundGroup(
		1.0F,
		1.0F,
		SoundEvents.BLOCK_CACTUS_FLOWER_BREAK,
		SoundEvents.INTENTIONALLY_EMPTY,
		SoundEvents.BLOCK_CACTUS_FLOWER_PLACE,
		SoundEvents.INTENTIONALLY_EMPTY,
		SoundEvents.INTENTIONALLY_EMPTY
	);
	...
	public static final BlockSoundGroup FLOWERBED = new BlockSoundGroup(
		1.0F,
		1.0F,
	...
	public static final BlockSoundGroup LEAF_LITTER = new BlockSoundGroup(
		1.0F,
		1.0F,
		SoundEvents.BLOCK_LEAF_LITTER_BREAK,
		SoundEvents.BLOCK_LEAF_LITTER_STEP,
		SoundEvents.BLOCK_LEAF_LITTER_PLACE,
		SoundEvents.BLOCK_LEAF_LITTER_HIT,
		SoundEvents.BLOCK_LEAF_LITTER_FALL
	);
	...
	public static final BlockSoundGroup RESIN = new BlockSoundGroup(
		1.0F,
		1.0F,
		SoundEvents.BLOCK_RESIN_BREAK,
		SoundEvents.BLOCK_RESIN_STEP,
		SoundEvents.BLOCK_RESIN_PLACE,
		SoundEvents.INTENTIONALLY_EMPTY,
		SoundEvents.BLOCK_RESIN_FALL
	);
	public static final BlockSoundGroup RESIN_BRICKS = new BlockSoundGroup(
		1.0F,
		1.0F,
		SoundEvents.BLOCK_RESIN_BRICKS_BREAK,
		SoundEvents.BLOCK_RESIN_BRICKS_STEP,
		SoundEvents.BLOCK_RESIN_BRICKS_PLACE,
		SoundEvents.BLOCK_RESIN_BRICKS_HIT,
		SoundEvents.BLOCK_RESIN_BRICKS_FALL
	);
	public static final BlockSoundGroup IRON = new BlockSoundGroup(
		1.0F, 1.0F, SoundEvents.BLOCK_IRON_BREAK, SoundEvents.BLOCK_IRON_STEP, SoundEvents.BLOCK_IRON_PLACE, SoundEvents.BLOCK_IRON_HIT, SoundEvents.BLOCK_IRON_FALL
	);
