...
public class Properties {
	...
	/**
	 * A property that specifies if a creaking heart is natural.
	 */
	...
	/**
	 * A property that specifies the amount of flowers in a flowerbed block.
	 */
	public static final IntProperty FLOWER_AMOUNT = IntProperty.of("flower_amount", 1, 4);
	/**
	 * A property that specifies the amount of segments in a segmented block.
	 */
	 ...
	 */
	public static final EnumProperty<CreakingHeartState> CREAKING_HEART_STATE = EnumProperty.of("creaking_heart_state", CreakingHeartState.class);
	/**
	...
	/**
	 * A property that specifies whether an item frame has a map in it.
	 * 
	 * <p>Yes, despite item frames being entities, they use block states. Weird, right?
	 */
