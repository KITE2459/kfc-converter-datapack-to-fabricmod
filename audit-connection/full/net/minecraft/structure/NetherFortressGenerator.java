...
public class NetherFortressGenerator {
	...
	public static class Bridge extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			BlockState blockState = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.SOUTH, true);
	...
	public static class BridgePlatform extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.EAST, true).with(FenceBlock.SOUTH, true), 0, 6, 8, chunkBox);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.SOUTH, true), 6, 6, 8, chunkBox);
			this.fillWithOutline(world, chunkBox, 1, 6, 8, 5, 6, 8, blockState, blockState, false);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.EAST, true), 1, 7, 8, chunkBox);
			this.fillWithOutline(world, chunkBox, 2, 7, 8, 4, 7, 8, blockState, blockState, false);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true), 5, 7, 8, chunkBox);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.EAST, true), 2, 8, 8, chunkBox);
			this.addBlock(world, blockState, 3, 8, 8, chunkBox);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true), 4, 8, 8, chunkBox);
	...
	public static class CorridorBalcony extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			BlockState blockState = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.SOUTH, true);
			BlockState blockState2 = Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.EAST, true);
			...
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.EAST, true).with(FenceBlock.SOUTH, true), 0, 3, 8, chunkBox);
			this.addBlock(world, Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.SOUTH, true), 8, 3, 8, chunkBox);
	...
	public static class CorridorExit extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			for (int ix = 3; ix <= 9; ix += 2) {
				this.fillWithOutline(world, chunkBox, 1, 7, ix, 1, 8, ix, blockState2.with(FenceBlock.WEST, true), blockState2.with(FenceBlock.WEST, true), false);
				this.fillWithOutline(world, chunkBox, 11, 7, ix, 11, 8, ix, blockState2.with(FenceBlock.EAST, true), blockState2.with(FenceBlock.EAST, true), false);
			}
