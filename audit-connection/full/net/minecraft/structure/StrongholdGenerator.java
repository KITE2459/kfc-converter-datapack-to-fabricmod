...
public class StrongholdGenerator {
	...
	public static class Library extends StrongholdGenerator.Piece {
		...
		public void generate(
			...
			if (this.tall) {
				...
				BlockState blockState = Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.EAST, true);
				BlockState blockState2 = Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.SOUTH, true);
				...
				this.addBlock(world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.EAST, true), 3, 6, 2, chunkBox);
				this.addBlock(world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true).with(FenceBlock.EAST, true), 3, 6, 12, chunkBox);
				this.addBlock(world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.WEST, true), 10, 6, 2, chunkBox);

				for (int m = 0; m <= 2; m++) {
					this.addBlock(world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true).with(FenceBlock.WEST, true), 8 + m, 6, 12 - m, chunkBox);
					if (m != 2) {
						this.addBlock(world, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true).with(FenceBlock.EAST, true), 8 + m, 6, 11 - m, chunkBox);
					}
				}
				...
				this.addBlock(world, blockState4.with(FenceBlock.NORTH, true), 6, 7, 6, chunkBox);
				this.addBlock(world, blockState4.with(FenceBlock.SOUTH, true), 6, 7, 8, chunkBox);
				this.addBlock(world, blockState5.with(FenceBlock.NORTH, true), 7, 7, 6, chunkBox);
				this.addBlock(world, blockState5.with(FenceBlock.SOUTH, true), 7, 7, 8, chunkBox);
	...
	abstract static class Piece extends StructurePiece {
		...
		public Piece(StructurePieceType structurePieceType, NbtCompound nbtCompound) {
			...
			this.entryDoor = (StrongholdGenerator.Piece.EntranceType)nbtCompound.get("EntryDoor", StrongholdGenerator.Piece.EntranceType.CODEC).orElseThrow();
		}

		@Override
		protected void writeNbt(StructureContext context, NbtCompound nbt) {
			nbt.put("EntryDoor", StrongholdGenerator.Piece.EntranceType.CODEC, this.entryDoor);
		}
		...
		protected void generateEntrance(
			...
			switch (type) {
				...
				case GRATES:
					...
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), x, y, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), x, y + 1, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true).with(PaneBlock.WEST, true), x, y + 2, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true).with(PaneBlock.WEST, true), x + 1, y + 2, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true).with(PaneBlock.WEST, true), x + 2, y + 2, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), x + 2, y + 1, z, boundingBox);
					this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), x + 2, y, z, boundingBox);
					break;
				case IRON_DOOR:
					this.addBlock(world, Blocks.STONE_BRICKS.getDefaultState(), x, y, z, boundingBox);
					this.addBlock(world, Blocks.STONE_BRICKS.getDefaultState(), x, y + 1, z, boundingBox);
		...
		protected static enum EntranceType {
			...
			@Deprecated
			public static final Codec<StrongholdGenerator.Piece.EntranceType> CODEC = Codecs.enumByName(StrongholdGenerator.Piece.EntranceType::valueOf);
		}
	}
	...
	public static class PortalRoom extends StrongholdGenerator.Piece {
		...
		public void generate(
			...
			this.addBlock(world, blockState4.with(EndPortalFrameBlock.EYE, bls[0]), 4, 3, 8, chunkBox);
			this.addBlock(world, blockState4.with(EndPortalFrameBlock.EYE, bls[1]), 5, 3, 8, chunkBox);
			this.addBlock(world, blockState4.with(EndPortalFrameBlock.EYE, bls[2]), 6, 3, 8, chunkBox);
			this.addBlock(world, blockState5.with(EndPortalFrameBlock.EYE, bls[3]), 4, 3, 12, chunkBox);
			this.addBlock(world, blockState5.with(EndPortalFrameBlock.EYE, bls[4]), 5, 3, 12, chunkBox);
	...
	public static class PrisonHall extends StrongholdGenerator.Piece {
		...
		public void generate(
			...
			for (int i = 1; i <= 3; i++) {
				this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true), 4, i, 4, chunkBox);
				this.addBlock(
					world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true).with(PaneBlock.EAST, true), 4, i, 5, chunkBox
				);
				this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true), 4, i, 6, chunkBox);
				this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true).with(PaneBlock.EAST, true), 5, i, 5, chunkBox);
				this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true).with(PaneBlock.EAST, true), 6, i, 5, chunkBox);
				this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true).with(PaneBlock.EAST, true), 7, i, 5, chunkBox);
			}

			this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true), 4, 3, 2, chunkBox);
			this.addBlock(world, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true).with(PaneBlock.SOUTH, true), 4, 3, 8, chunkBox);
