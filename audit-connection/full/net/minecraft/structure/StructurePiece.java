...
public abstract class StructurePiece {
	...
	public StructurePiece(StructurePieceType type, NbtCompound nbt) {
		this(type, nbt.getInt("GD", 0), (BlockBox)nbt.get("BB", BlockBox.CODEC).orElseThrow());
		int i = nbt.getInt("O", 0);
		this.setOrientation(i == -1 ? null : Direction.fromHorizontalQuarterTurns(i));
	}
	...
	public final NbtCompound toNbt(StructureContext context) {
		...
		nbtCompound.put("BB", BlockBox.CODEC, this.boundingBox);
		Direction direction = this.getFacing();
		nbtCompound.putInt("O", direction == null ? -1 : direction.getHorizontalQuarterTurns());
