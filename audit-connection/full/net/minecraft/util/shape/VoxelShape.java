	...
	public BlockHitResult raycast(Vec3d start, Vec3d end, BlockPos pos) {
		if (this.isEmpty()) {
			...
			if (vec3d.lengthSquared() < 1.0E-7) {
				...
				return this.voxels
						.inBoundsAndContains(
							this.getCoordIndex(Direction.Axis.X, vec3d2.x - pos.getX()),
							this.getCoordIndex(Direction.Axis.Y, vec3d2.y - pos.getY()),
							this.getCoordIndex(Direction.Axis.Z, vec3d2.z - pos.getZ())
						)
