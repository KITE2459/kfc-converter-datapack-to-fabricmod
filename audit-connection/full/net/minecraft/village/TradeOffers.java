...
public class TradeOffers {
	...
	private static final int NOVICE_SELL_EXPERIENCE = 1;
	private static final int NOVICE_BUY_EXPERIENCE = 2;
	private static final int APPRENTICE_SELL_EXPERIENCE = 5;
	private static final int APPRENTICE_BUY_EXPERIENCE = 10;
	private static final int JOURNEYMAN_SELL_EXPERIENCE = 10;
	private static final int JOURNEYMAN_BUY_EXPERIENCE = 20;
	private static final int EXPERT_SELL_EXPERIENCE = 15;
	private static final int EXPERT_BUY_EXPERIENCE = 30;
	private static final int MASTER_TRADE_EXPERIENCE = 30;
	private static final float LOW_PRICE_MULTIPLIER = 0.05F;
	private static final float HIGH_PRICE_MULTIPLIER = 0.2F;
	public static final Map<RegistryKey<VillagerProfession>, Int2ObjectMap<TradeOffers.Factory[]>> PROFESSION_TO_LEVELED_TRADE = Util.make(
		Maps.<RegistryKey<VillagerProfession>, Int2ObjectMap<TradeOffers.Factory[]>>newHashMap(),
		map -> {
			map.put(
			...
			map.put(
				...
				copyToFastUtilMap(
					ImmutableMap.of(
						1,
						new TradeOffers.Factory[]{new TradeOffers.BuyItemFactory(Items.PAPER, 24, 12, 2), new TradeOffers.SellItemFactory(Items.MAP, 7, 1, 12, 1, 0.05F)},
						2,
						new TradeOffers.Factory[]{
							new TradeOffers.BuyItemFactory(Items.GLASS_PANE, 11, 12, 10),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_TAIGA_VILLAGE_MAPS, "filled_map.village_taiga", MapDecorationTypes.VILLAGE_TAIGA, 12, 5),
								VillagerType.SWAMP,
								VillagerType.SNOW,
								VillagerType.PLAINS
							),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_SWAMP_EXPLORER_MAPS, "filled_map.explorer_swamp", MapDecorationTypes.SWAMP_HUT, 12, 5),
								VillagerType.TAIGA,
								VillagerType.SNOW,
								VillagerType.JUNGLE
							),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_SNOWY_VILLAGE_MAPS, "filled_map.village_snowy", MapDecorationTypes.VILLAGE_SNOWY, 12, 5),
								VillagerType.TAIGA,
								VillagerType.SWAMP
							),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_SAVANNA_VILLAGE_MAPS, "filled_map.village_savanna", MapDecorationTypes.VILLAGE_SAVANNA, 12, 5),
								VillagerType.PLAINS,
								VillagerType.JUNGLE,
								VillagerType.DESERT
							),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_PLAINS_VILLAGE_MAPS, "filled_map.village_plains", MapDecorationTypes.VILLAGE_PLAINS, 12, 5),
								VillagerType.TAIGA,
								VillagerType.SNOW,
							...
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_JUNGLE_EXPLORER_MAPS, "filled_map.explorer_jungle", MapDecorationTypes.JUNGLE_TEMPLE, 12, 5),
								VillagerType.SWAMP,
								VillagerType.SAVANNA,
								VillagerType.DESERT
							),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellMapFactory(8, StructureTags.ON_DESERT_VILLAGE_MAPS, "filled_map.village_desert", MapDecorationTypes.VILLAGE_DESERT, 12, 5),
								VillagerType.SAVANNA,
								VillagerType.JUNGLE
							)
						},
						...
						4,
						new TradeOffers.Factory[]{
							new TradeOffers.SellItemFactory(Items.ITEM_FRAME, 7, 1, 12, 15, 0.05F),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.BLUE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.TAIGA),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.WHITE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.PLAINS),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.RED_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.SAVANNA),
							TradeOffers.TypedWrapperFactory.of(
								new TradeOffers.SellItemFactory(Items.GREEN_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT, VillagerType.SAVANNA, VillagerType.JUNGLE
							),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.LIME_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT, VillagerType.TAIGA),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.PURPLE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.TAIGA, VillagerType.SWAMP),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.CYAN_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT, VillagerType.SNOW),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.YELLOW_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.PLAINS, VillagerType.JUNGLE),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.ORANGE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SAVANNA, VillagerType.DESERT),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.BROWN_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.PLAINS, VillagerType.JUNGLE),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.MAGENTA_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SAVANNA),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.LIGHT_BLUE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.SWAMP),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.PINK_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.TAIGA, VillagerType.PLAINS),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.GRAY_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT),
							TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.BLACK_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SWAMP)
						},
						5,
						new TradeOffers.Factory[]{
							new TradeOffers.SellItemFactory(Items.GLOBE_BANNER_PATTERN, 8, 1, 12, 30, 0.05F),
							new TradeOffers.SellMapFactory(14, StructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapDecorationTypes.MANSION, 12, 30)
						}
					)
				)
			);
	...
	public static final List<Pair<TradeOffers.Factory[], Integer>> WANDERING_TRADER_TRADES = ImmutableList.<Pair<TradeOffers.Factory[], Integer>>builder()
		.add(
			Pair.of(
				new TradeOffers.Factory[]{
					new TradeOffers.BuyItemFactory(createPotion(Potions.WATER), 2, 1, 1),
		...
		.build();
	public static final Map<RegistryKey<VillagerProfession>, Int2ObjectMap<TradeOffers.Factory[]>> REBALANCED_PROFESSION_TO_LEVELED_TRADE = Map.of(
		VillagerProfession.LIBRARIAN,
		copyToFastUtilMap(
			ImmutableMap.<Integer, TradeOffers.Factory[]>builder()
				.put(
	...
	private static TradeOffers.Factory createLibrarianTradeFactory(int experience) {
		return new TradeOffers.TypedWrapperFactory(
			ImmutableMap.<RegistryKey<VillagerType>, TradeOffers.Factory>builder()
	...
	public record TypedWrapperFactory(Map<RegistryKey<VillagerType>, TradeOffers.Factory> typeToFactory) implements TradeOffers.Factory {
		@SafeVarargs
		public static TradeOffers.TypedWrapperFactory of(TradeOffers.Factory factory, RegistryKey<VillagerType>... types) {
			return new TradeOffers.TypedWrapperFactory(
				(Map<RegistryKey<VillagerType>, TradeOffers.Factory>)Arrays.stream(types).collect(Collectors.toMap(registryKey -> registryKey, registryKey -> factory))
			);
		}
		...
		public TradeOffer create(Entity entity, Random random) {
			if (entity instanceof VillagerDataContainer villagerDataContainer) {
				...
				if (registryKey == null) {
					...
					TradeOffers.Factory factory = (TradeOffers.Factory)this.typeToFactory.get(registryKey);
