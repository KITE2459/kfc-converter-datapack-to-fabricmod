...
public class StructureLocator {
	...
	private Object2IntMap<Structure> collectStructuresAndReferences(NbtCompound nbt) {
		Optional<NbtCompound> optional = nbt.getCompound("structures").flatMap(nbtCompoundx -> nbtCompoundx.getCompound("starts"));
		if (optional.isEmpty()) {
			return null;
		} else {
			NbtCompound nbtCompound = (NbtCompound)optional.get();
