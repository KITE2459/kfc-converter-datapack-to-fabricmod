...
public class OverworldBiomeCreator {
	...
	private static Biome createOcean(
		...
		return createBiome(true, 0.5F, 0.5F, waterColor, waterFogColor, null, null, null, spawnSettings, generationSettings, DEFAULT_MUSIC);
	}
	...
	public static Biome createTaiga(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup, boolean snowy) {
		...
		return createBiome(true, f, snowy ? 0.4F : 0.8F, snowy ? 4020182 : 4159204, 329011, null, null, null, builder, lookupBackedBuilder, DEFAULT_MUSIC);
	}
	...
	public static Biome createRiver(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup, boolean frozen) {
		...
		return createBiome(true, f, 0.5F, frozen ? 3750089 : 4159204, 329011, null, null, null, builder, lookupBackedBuilder, DEFAULT_MUSIC);
	}
	...
	public static Biome createBeach(
		...
		return createBiome(true, f, bl ? 0.4F : 0.3F, snowy ? 4020182 : 4159204, 329011, null, null, null, builder, lookupBackedBuilder, DEFAULT_MUSIC);
	}
	...
	public static Biome createMeadow(RegistryEntryLookup<PlacedFeature> featureLookup, RegistryEntryLookup<ConfiguredCarver<?>> carverLookup, boolean cherryGrove) {
		...
		return cherryGrove
			? createBiome(true, 0.5F, 0.8F, 6141935, 6141935, 11983713, 11983713, null, builder, lookupBackedBuilder, musicSound)
			: createBiome(true, 0.5F, 0.8F, 937679, 329011, null, null, null, builder, lookupBackedBuilder, musicSound);
	}
