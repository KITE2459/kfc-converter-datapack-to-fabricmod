...
public class WorldBorder {
	...
	public List<WorldBorder.DistanceFromCamera> calculateDistancesFromCamera(double x, double z) {
		WorldBorder.DistanceFromCamera[] distanceFromCameras = new WorldBorder.DistanceFromCamera[]{
			new WorldBorder.DistanceFromCamera(Direction.NORTH, z - this.getBoundNorth()),
			new WorldBorder.DistanceFromCamera(Direction.SOUTH, this.getBoundSouth() - z),
			new WorldBorder.DistanceFromCamera(Direction.WEST, x - this.getBoundWest()),
			new WorldBorder.DistanceFromCamera(Direction.EAST, this.getBoundEast() - x)
		};
		return Arrays.stream(distanceFromCameras).sorted(Comparator.comparingDouble(distanceFromCamera -> distanceFromCamera.distance)).toList();
	}
	...
	public record DistanceFromCamera(Direction direction, double distance) {
	}
