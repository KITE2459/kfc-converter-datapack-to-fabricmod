...
public class VegetationConfiguredFeatures {
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		RegistryEntry<PlacedFeature> registryEntry6 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.PALE_OAK_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry7 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.PALE_OAK_CREAKING_CHECKED);
		...
		RegistryEntry<PlacedFeature> registryEntry18 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.BIRCH_BEES_002_LEAF_LITTER);
		RegistryEntry<PlacedFeature> registryEntry19 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FANCY_OAK_BEES_0002);
		RegistryEntry<PlacedFeature> registryEntry20 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.JUNGLE_BUSH);
		RegistryEntry<PlacedFeature> registryEntry21 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_SPRUCE_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry22 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_PINE_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry23 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_JUNGLE_TREE_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry24 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.TALL_MANGROVE_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry25 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry26 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_BEES_002);
		RegistryEntry<PlacedFeature> registryEntry27 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.SUPER_BIRCH_BEES);
		RegistryEntry<PlacedFeature> registryEntry28 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.SPRUCE_ON_SNOW);
		RegistryEntry<PlacedFeature> registryEntry29 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_BEES_0002);
		RegistryEntry<PlacedFeature> registryEntry30 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.JUNGLE_TREE);
		RegistryEntry<PlacedFeature> registryEntry31 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MANGROVE_CHECKED);
		RegistryEntry<PlacedFeature> registryEntry32 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_LEAF_LITTER);
		RegistryEntry<PlacedFeature> registryEntry33 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.DARK_OAK_LEAF_LITTER);
		RegistryEntry<PlacedFeature> registryEntry34 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.BIRCH_LEAF_LITTER);
		RegistryEntry<PlacedFeature> registryEntry35 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FANCY_OAK_LEAF_LITTER);
		RegistryEntry<PlacedFeature> registryEntry36 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_OAK_TREE);
		RegistryEntry<PlacedFeature> registryEntry37 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_BIRCH_TREE);
		RegistryEntry<PlacedFeature> registryEntry38 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_SUPER_BIRCH_TREE);
		RegistryEntry<PlacedFeature> registryEntry39 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_JUNGLE_TREE);
		RegistryEntry<PlacedFeature> registryEntry40 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_SPRUCE_TREE);
		...
		ConfiguredFeatures.register(
			...
			createRandomPatchFeatureConfig(
				new WeightedBlockStateProvider(Pool.<BlockState>builder().add(Blocks.SHORT_GRASS.getDefaultState(), 1).add(Blocks.FERN.getDefaultState(), 4)), 32
			)
		);
		ConfiguredFeatures.register(
		...
		ConfiguredFeatures.register(
			featureRegisterable, PATCH_GRASS_MEADOW, Feature.RANDOM_PATCH, createRandomPatchFeatureConfig(BlockStateProvider.of(Blocks.SHORT_GRASS), 16)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			PATCH_LEAF_LITTER,
			Feature.RANDOM_PATCH,
			ConfiguredFeatures.createRandomPatchFeatureConfig(
				32, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(leafLitter(1, 3))))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			new RandomPatchFeatureConfig(
				...
				PlacedFeatures.createEntry(
					...
					new SimpleBlockFeatureConfig(
						new WeightedBlockStateProvider(Pool.<BlockState>builder().add(Blocks.SHORT_GRASS.getDefaultState(), 3).add(Blocks.FERN.getDefaultState(), 1))
					),
		...
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_PATCH,
			createRandomPatchFeatureConfig(
				new WeightedBlockStateProvider(Pool.<BlockState>builder().add(Blocks.SHORT_DRY_GRASS.getDefaultState(), 1).add(Blocks.TALL_DRY_GRASS.getDefaultState(), 1)),
				64
			)
		);
		ConfiguredFeatures.register(
		...
		ConfiguredFeatures.register(
			...
			PATCH_BUSH,
			Feature.RANDOM_PATCH,
			new RandomPatchFeatureConfig(24, 5, 3, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.BUSH))))
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			PATCH_CACTUS,
			...
			ConfiguredFeatures.createRandomPatchFeatureConfig(
				...
				PlacedFeatures.createEntry(
					...
					new BlockColumnFeatureConfig(
						List.of(
							BlockColumnFeatureConfig.createLayer(BiasedToBottomIntProvider.create(1, 3), BlockStateProvider.of(Blocks.CACTUS)),
							BlockColumnFeatureConfig.createLayer(
								new WeightedListIntProvider(Pool.<IntProvider>builder().add(ConstantIntProvider.create(0), 3).add(ConstantIntProvider.create(1), 1).build()),
		...
		ConfiguredFeatures.register(
			...
			new RandomPatchFeatureConfig(
				...
				PlacedFeatures.createEntry(
					...
					wouldSurviveNearWaterModifier(Blocks.SUGAR_CANE)
				)
			)
		);
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_PATCH,
			new RandomPatchFeatureConfig(
				20, 4, 3, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.FIREFLY_BUSH)))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			Feature.FLOWER,
			createRandomPatchFeatureConfig(
				new WeightedBlockStateProvider(Pool.<BlockState>builder().add(Blocks.POPPY.getDefaultState(), 2).add(Blocks.DANDELION.getDefaultState(), 1)), 64
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
		...
		ConfiguredFeatures.register(
			...
			Feature.FLOWER,
			new RandomPatchFeatureConfig(
				96, 6, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(flowerbed(Blocks.PINK_PETALS))))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			Feature.FLOWER,
			new RandomPatchFeatureConfig(
				64, 6, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(flowerbed(Blocks.WILDFLOWERS))))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			Feature.FLOWER,
			new RandomPatchFeatureConfig(
				8, 6, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(flowerbed(Blocks.WILDFLOWERS))))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			Feature.FLOWER,
			new RandomPatchFeatureConfig(
				1, 0, 0, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.CLOSED_EYEBLOSSOM), true))
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
		...
		ConfiguredFeatures.register(
			...
			PALE_FOREST_FLOWERS,
			Feature.RANDOM_PATCH,
			ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.CLOSED_EYEBLOSSOM), true))
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			new RandomFeatureConfig(
				List.of(
					...
					new RandomFeatureEntry(registryEntry33, 0.6666667F),
					new RandomFeatureEntry(registryEntry37, 0.0025F),
					new RandomFeatureEntry(registryEntry34, 0.2F),
					new RandomFeatureEntry(registryEntry36, 0.0125F),
					new RandomFeatureEntry(registryEntry35, 0.1F)
				),
				registryEntry32
			)
		);
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry7, 0.1F), new RandomFeatureEntry(registryEntry6, 0.9F)), registryEntry6)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
		...
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(
				List.of(new RandomFeatureEntry(registryEntry37, 0.0025F), new RandomFeatureEntry(registryEntry9, 0.2F), new RandomFeatureEntry(registryEntry10, 0.1F)),
				registryEntry26
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable, MEADOW_TREES, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry11, 0.5F)), registryEntry27)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_TAIGA,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry12, 0.33333334F), new RandomFeatureEntry(registryEntry40, 0.0125F)), registryEntry13)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_BADLANDS,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry36, 0.0125F)), registryEntry32)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_GROVE,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry14, 0.33333334F)), registryEntry28)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_SAVANNA,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry15, 0.8F), new RandomFeatureEntry(registryEntry36, 0.0125F)), registryEntry25)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_SNOWY,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry40, 0.0125F)), registryEntry13)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_BIRCH,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry37, 0.0125F)), registryEntry17)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			BIRCH_TALL,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(
				List.of(new RandomFeatureEntry(registryEntry38, 0.00625F), new RandomFeatureEntry(registryEntry16, 0.5F), new RandomFeatureEntry(registryEntry37, 0.0125F)),
				registryEntry17
			)
		);
		ConfiguredFeatures.register(
			...
			new RandomFeatureConfig(
				List.of(
					new RandomFeatureEntry(registryEntry40, 0.008325F),
					new RandomFeatureEntry(registryEntry13, 0.666F),
		...
		ConfiguredFeatures.register(
			featureRegisterable, TREES_WATER, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry8, 0.1F)), registryEntry25)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			TREES_BIRCH_AND_OAK,
			...
			new RandomFeatureConfig(
				List.of(
					new RandomFeatureEntry(registryEntry37, 0.0025F),
					new RandomFeatureEntry(registryEntry18, 0.2F),
					new RandomFeatureEntry(registryEntry19, 0.1F),
					new RandomFeatureEntry(registryEntry36, 0.0125F)
				),
				registryEntry29
			)
		...
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(
				List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(registryEntry3), 0.33333334F), new RandomFeatureEntry(registryEntry36, 0.0125F)),
				PlacedFeatures.createEntry(registryEntry4)
			)
		);
		ConfiguredFeatures.register(
			featureRegisterable,
			...
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(
				List.of(new RandomFeatureEntry(registryEntry8, 0.1F), new RandomFeatureEntry(registryEntry20, 0.5F), new RandomFeatureEntry(registryEntry39, 0.0125F)),
				registryEntry30
			)
		);
		ConfiguredFeatures.register(
			...
			new RandomFeatureConfig(
				List.of(
					new RandomFeatureEntry(registryEntry21, 0.33333334F),
					new RandomFeatureEntry(registryEntry12, 0.33333334F),
					new RandomFeatureEntry(registryEntry40, 0.0125F)
				),
				registryEntry13
			)
		);
		ConfiguredFeatures.register(
			...
			new RandomFeatureConfig(
				List.of(
					new RandomFeatureEntry(registryEntry21, 0.025641026F),
					new RandomFeatureEntry(registryEntry22, 0.30769232F),
					new RandomFeatureEntry(registryEntry12, 0.33333334F),
					new RandomFeatureEntry(registryEntry40, 0.0125F)
				),
				registryEntry13
		...
		ConfiguredFeatures.register(
			...
			new RandomFeatureConfig(
				List.of(
					new RandomFeatureEntry(registryEntry8, 0.1F),
					new RandomFeatureEntry(registryEntry20, 0.5F),
					new RandomFeatureEntry(registryEntry23, 0.33333334F),
					new RandomFeatureEntry(registryEntry39, 0.0125F)
				),
				registryEntry30
			)
		);
		ConfiguredFeatures.register(
			...
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(
				List.of(new RandomFeatureEntry(registryEntry8, 0.05F), new RandomFeatureEntry(registryEntry20, 0.15F), new RandomFeatureEntry(registryEntry23, 0.7F)),
		...
		ConfiguredFeatures.register(
			...
			MANGROVE_VEGETATION,
			Feature.RANDOM_SELECTOR,
			new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry24, 0.85F)), registryEntry31)
		);
	}
	...
	public static BlockFilterPlacementModifier wouldSurviveNearWaterModifier(Block block) {
		return BlockFilterPlacementModifier.of(
			BlockPredicate.allOf(
				BlockPredicate.IS_AIR,
				BlockPredicate.wouldSurvive(block.getDefaultState(), BlockPos.ORIGIN),
