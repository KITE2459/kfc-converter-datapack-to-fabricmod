...
public class VegetationPlacedFeatures {
	...
	public static final RegistryKey<PlacedFeature> PATCH_GRASS_MEADOW = PlacedFeatures.of("patch_grass_meadow");
	...
	public static final RegistryKey<PlacedFeature> PATCH_DRY_GRASS_BADLANDS = PlacedFeatures.of("patch_dry_grass_badlands");
	public static final RegistryKey<PlacedFeature> PATCH_DRY_GRASS_DESERT = PlacedFeatures.of("patch_dry_grass_desert");
	...
	public static final RegistryKey<PlacedFeature> PATCH_BUSH = PlacedFeatures.of("patch_bush");
	public static final RegistryKey<PlacedFeature> PATCH_LEAF_LITTER = PlacedFeatures.of("patch_leaf_litter");
	...
	public static final RegistryKey<PlacedFeature> PATCH_FIREFLY_BUSH = PlacedFeatures.of("patch_firefly_bush_swamp");
	public static final RegistryKey<PlacedFeature> PATCH_FIREFLY_BUSH_NEAR_WATER_SWAMP = PlacedFeatures.of("patch_firefly_bush_near_water_swamp");
	public static final RegistryKey<PlacedFeature> PATCH_FIREFLY_BUSH_NEAR_WATER = PlacedFeatures.of("patch_firefly_bush_near_water");
	...
	public static final RegistryKey<PlacedFeature> WILDFLOWERS_BIRCH_FOREST = PlacedFeatures.of("wildflowers_birch_forest");
	public static final RegistryKey<PlacedFeature> WILDFLOWERS_MEADOW = PlacedFeatures.of("wildflowers_meadow");
	...
	public static final RegistryKey<PlacedFeature> TREES_BIRCH_AND_OAK = PlacedFeatures.of("trees_birch_and_oak_leaf_litter");
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry7 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_GRASS_MEADOW);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry8 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_LEAF_LITTER);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry9 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_TAIGA_GRASS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry10 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_GRASS_JUNGLE);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry11 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.SINGLE_PIECE_OF_GRASS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry12 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_DEAD_BUSH);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry13 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_DRY_GRASS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry14 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_FIREFLY_BUSH);
		...
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry20 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_BUSH);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry21 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_CACTUS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry22 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_SUGAR_CANE);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry23 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_BROWN_MUSHROOM);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry24 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_RED_MUSHROOM);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry25 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_DEFAULT);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry26 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_FLOWER_FOREST);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry27 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_SWAMP);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry28 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_PLAIN);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry29 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_MEADOW);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry30 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_CHERRY);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry31 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FLOWER_PALE_GARDEN);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry32 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.WILDFLOWERS_BIRCH_FOREST);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry33 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.WILDFLOWERS_MEADOW);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry34 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_PLAINS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry35 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.DARK_FOREST_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry36 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_GARDEN_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry37 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.FOREST_FLOWERS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry38 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_FOREST_FLOWERS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry39 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PALE_MOSS_PATCH);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry40 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_FLOWER_FOREST);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry41 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MEADOW_TREES);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry42 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_TAIGA);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry43 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_BADLANDS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry44 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_GROVE);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry45 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_SNOWY);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry46 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.CHERRY_BEES_005);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry47 = registryEntryLookup.getOrThrow(TreeConfiguredFeatures.SWAMP_OAK);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry48 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_SAVANNA);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry49 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.BIRCH_TALL);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry50 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_BIRCH);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry51 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_WINDSWEPT_HILLS);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry52 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_WATER);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry53 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_BIRCH_AND_OAK);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry54 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_SPARSE_JUNGLE);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry55 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry56 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry57 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.TREES_JUNGLE);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry58 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.BAMBOO_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry59 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MUSHROOM_ISLAND_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>> registryEntry60 = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.MANGROVE_VEGETATION);
		...
		PlacedFeatures.register(featureRegisterable, PATCH_LEAF_LITTER, registryEntry8, modifiers(2));
		PlacedFeatures.register(
			featureRegisterable,
		...
		PlacedFeatures.register(featureRegisterable, PATCH_GRASS_TAIGA, registryEntry9, modifiers(7));
		PlacedFeatures.register(featureRegisterable, PATCH_GRASS_JUNGLE, registryEntry10, modifiers(25));
		PlacedFeatures.register(featureRegisterable, GRASS_BONEMEAL, registryEntry11, PlacedFeatures.isAir());
		PlacedFeatures.register(featureRegisterable, PATCH_DEAD_BUSH_2, registryEntry12, modifiers(2));
		PlacedFeatures.register(
			featureRegisterable, PATCH_DEAD_BUSH, registryEntry12, SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of()
		);
		PlacedFeatures.register(featureRegisterable, PATCH_DEAD_BUSH_BADLANDS, registryEntry12, modifiers(20));
		PlacedFeatures.register(
			featureRegisterable,
		...
		PlacedFeatures.register(
			...
			BiomePlacementModifier.of(),
			VegetationConfiguredFeatures.wouldSurviveNearWaterModifier(Blocks.FIREFLY_BUSH)
		);
		PlacedFeatures.register(
			featureRegisterable,
		...
		PlacedFeatures.register(featureRegisterable, BROWN_MUSHROOM_NORMAL, registryEntry23, mushroomModifiers(256, null));
		PlacedFeatures.register(featureRegisterable, RED_MUSHROOM_NORMAL, registryEntry24, mushroomModifiers(512, null));
		PlacedFeatures.register(featureRegisterable, BROWN_MUSHROOM_TAIGA, registryEntry23, mushroomModifiers(4, null));
		PlacedFeatures.register(featureRegisterable, RED_MUSHROOM_TAIGA, registryEntry24, mushroomModifiers(256, null));
		PlacedFeatures.register(featureRegisterable, BROWN_MUSHROOM_OLD_GROWTH, registryEntry23, mushroomModifiers(4, CountPlacementModifier.of(3)));
		PlacedFeatures.register(featureRegisterable, RED_MUSHROOM_OLD_GROWTH, registryEntry24, mushroomModifiers(171, null));
		PlacedFeatures.register(featureRegisterable, BROWN_MUSHROOM_SWAMP, registryEntry23, mushroomModifiers(0, CountPlacementModifier.of(2)));
		PlacedFeatures.register(featureRegisterable, RED_MUSHROOM_SWAMP, registryEntry24, mushroomModifiers(64, null));
		PlacedFeatures.register(
			featureRegisterable,
			FLOWER_WARM,
			registryEntry25,
		...
		PlacedFeatures.register(
			featureRegisterable, FLOWER_MEADOW, registryEntry29, SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()
		);
		PlacedFeatures.register(
			featureRegisterable,
			FLOWER_PALE_GARDEN,
		...
		PlacedFeatures.register(featureRegisterable, TREES_FLOWER_FOREST, registryEntry40, treeModifiers(PlacedFeatures.createCountExtraModifier(6, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_MEADOW, registryEntry41, treeModifiers(RarityFilterPlacementModifier.of(100)));
		PlacedFeatures.register(
			featureRegisterable,
			TREES_CHERRY,
			registryEntry46,
		...
		PlacedFeatures.register(featureRegisterable, TREES_TAIGA, registryEntry42, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_GROVE, registryEntry44, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
		PlacedFeatures.register(
			featureRegisterable, TREES_BADLANDS, registryEntry43, treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(5, 0.1F, 1), Blocks.OAK_SAPLING)
		);
		PlacedFeatures.register(
			featureRegisterable, TREES_SNOWY, registryEntry45, treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.1F, 1), Blocks.SPRUCE_SAPLING)
		);
		PlacedFeatures.register(
			featureRegisterable,
			TREES_SWAMP,
		...
		PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_SAVANNA, registryEntry48, treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_SAVANNA, registryEntry48, treeModifiers(PlacedFeatures.createCountExtraModifier(1, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, BIRCH_TALL, registryEntry49, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
		PlacedFeatures.register(
			featureRegisterable, TREES_BIRCH, registryEntry50, treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1), Blocks.BIRCH_SAPLING)
		);
		PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_FOREST, registryEntry51, treeModifiers(PlacedFeatures.createCountExtraModifier(3, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_HILLS, registryEntry51, treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_WATER, registryEntry52, treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_BIRCH_AND_OAK, registryEntry53, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, TREES_SPARSE_JUNGLE, registryEntry54, treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1F, 1)));
		PlacedFeatures.register(
			featureRegisterable, TREES_OLD_GROWTH_SPRUCE_TAIGA, registryEntry55, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1))
		);
		PlacedFeatures.register(
			featureRegisterable, TREES_OLD_GROWTH_PINE_TAIGA, registryEntry56, treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1F, 1))
		);
		PlacedFeatures.register(featureRegisterable, TREES_JUNGLE, registryEntry57, treeModifiers(PlacedFeatures.createCountExtraModifier(50, 0.1F, 1)));
		PlacedFeatures.register(featureRegisterable, BAMBOO_VEGETATION, registryEntry58, treeModifiers(PlacedFeatures.createCountExtraModifier(30, 0.1F, 1)));
		PlacedFeatures.register(
			featureRegisterable,
