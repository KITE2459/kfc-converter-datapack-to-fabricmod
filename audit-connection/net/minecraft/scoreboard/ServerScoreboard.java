...
public class ServerScoreboard extends Scoreboard {
	public static final PersistentStateType<ScoreboardState> STATE_TYPE = new PersistentStateType<>(
		"scoreboard", context -> context.getWorldOrThrow().getScoreboard().createState(), context -> {
