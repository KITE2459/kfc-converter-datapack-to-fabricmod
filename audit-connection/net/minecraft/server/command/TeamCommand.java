							...
							CommandManager.argument("team", StringArgumentType.word())
								...
								.then(
									CommandManager.argument("displayName", TextArgumentType.text(registryAccess))
										.executes(
											context -> executeAdd(context.getSource(), StringArgumentType.getString(context, "team"), TextArgumentType.parseTextArgument(context, "displayName"))
										)
								)
						)
				)
				...
				.then(
					CommandManager.literal("join")
						.then(
							CommandManager.argument("team", TeamArgumentType.team())
								.executes(
									context -> executeJoin(context.getSource(), TeamArgumentType.getTeam(context, "team"), Collections.singleton(context.getSource().getEntityOrThrow()))
								)
								.then(
											...
											CommandManager.argument("displayName", TextArgumentType.text(registryAccess))
												.executes(
													context -> executeModifyDisplayName(
														context.getSource(), TeamArgumentType.getTeam(context, "team"), TextArgumentType.parseTextArgument(context, "displayName")
													)
												)
										)
								)
											...
											CommandManager.argument("prefix", TextArgumentType.text(registryAccess))
												.executes(
													context -> executeModifyPrefix(
														context.getSource(), TeamArgumentType.getTeam(context, "team"), TextArgumentType.parseTextArgument(context, "prefix")
													)
												)
										)
								)
											...
											CommandManager.argument("suffix", TextArgumentType.text(registryAccess))
												.executes(
													context -> executeModifySuffix(
														context.getSource(), TeamArgumentType.getTeam(context, "team"), TextArgumentType.parseTextArgument(context, "suffix")
													)
												)
										)
								)
