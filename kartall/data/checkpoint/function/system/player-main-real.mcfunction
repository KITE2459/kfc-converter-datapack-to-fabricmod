...
execute positioned ~-15 -64 ~-15 as @e[dx=30,dy=384,dz=30,tag=check-point,tag=!check-large,type=marker] run function checkpoint:system/as-checkpoint-entity
execute positioned ~-30 -64 ~-30 as @e[dx=60,dy=384,dz=60,tag=check-point,tag=check-large,type=marker] run function checkpoint:system/as-checkpoint-entity
