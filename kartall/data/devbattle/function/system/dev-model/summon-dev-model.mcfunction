...
execute if score #dev dev-count matches 10 run function devbattle:system/dev-model/dao
execute if score #dev dev-count matches 11 run function devbattle:system/dev-model/ecyce