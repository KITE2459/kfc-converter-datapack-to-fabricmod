...
scoreboard players remove @n[tag=carA,scores={kartweirdcollisioncount=4..,kartmove=5000..}] kartmove 5000
scoreboard players remove @n[tag=carB,scores={kartweirdcollisioncount=4..,kartmove=5000..}] kartmove 5000
