...
execute if score #hitbox-length-temp kartcollisiontime matches 8.. positioned ^ ^ ^0.8 run return run function kartmain:collision/rectangle-hitbox/tp-tree/0.8
