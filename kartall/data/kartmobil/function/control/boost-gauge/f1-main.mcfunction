...
#RPM 역산
# 2760
scoreboard players set #temp kartboostgauge 2680
execute if score @s kartmaxboostcount matches 3.. run scoreboard players set #temp kartboostgauge 2610
...
execute if score @s kartmaxboostcount matches ..2 run execute store result storage minecraft:kartmain gear-rpm int 0.0773 run scoreboard players get @s kartboostgauge
execute if score @s kartmaxboostcount matches 3.. run execute store result storage minecraft:kartmain gear-rpm int 0.0862 run scoreboard players get @s kartboostgauge
...
function kartmobil:control/boost-gauge/left-right/f1-leftgauge
...
function kartmobil:control/boost-gauge/left-right/f1-rightgauge
