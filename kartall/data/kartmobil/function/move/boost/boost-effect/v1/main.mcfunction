...
#듀얼부스터 이펙트
execute if score @s kartboosttime matches 42 run function kartmobil:move/boost/boost-effect/v1/dualboost-transform-particle
execute if score @s kartboosttime matches 35 run function kartmobil:move/boost/boost-effect/v1/dualboost-burst-particle
execute if score @s kartboosttime matches ..35 run function kartmobil:move/boost/boost-effect/v1/dualboost-particle
