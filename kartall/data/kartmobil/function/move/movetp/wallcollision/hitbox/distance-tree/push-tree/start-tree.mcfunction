...
execute if score #hitbox-radius-temp kartcollisiontime matches 8.. positioned ^ ^ ^0.8 run return run function kartmobil:move/movetp/wallcollision/hitbox/distance-tree/push-tree/0.8
execute if score #hitbox-radius-temp kartcollisiontime matches 4.. positioned ^ ^ ^0.4 run return run function kartmobil:move/movetp/wallcollision/hitbox/distance-tree/push-tree/0.4
