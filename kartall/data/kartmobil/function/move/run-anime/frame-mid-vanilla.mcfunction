...
execute if entity @s[tag=garage-show] as @e[tag=kart-run-anime,distance=..0.3,type=#kartmobil:kartmodels] run function kartmobil:move/run-anime/show-by-case/frame-mid
