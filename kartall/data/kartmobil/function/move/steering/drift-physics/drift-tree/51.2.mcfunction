scoreboard players remove #drift-escape-force kartdrift 512

execute if score #drift-escape-force kartdrift matches 256.. positioned ^ ^ ^25.6 run return run function kartmobil:move/steering/drift-physics/drift-tree/25.6
