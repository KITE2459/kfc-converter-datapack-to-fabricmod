...
execute if score #kart-skid-distance-temp kartdrift matches 4.. positioned ^ ^ ^-0.4 run return run function kartmobil:move/steering/drift/skidparticle/skid-tree/second-tree/particle-tree/0.4
