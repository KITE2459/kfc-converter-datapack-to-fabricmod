...
execute if score #kart-skid-distance-temp kartdrift matches 8.. positioned ^ ^ ^0.8 run return run function kartmobil:move/steering/drift/skidparticle/skid-tree/second-tree/particle-tree/side-tree/0.8
