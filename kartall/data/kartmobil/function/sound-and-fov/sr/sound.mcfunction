...
execute store result storage kartmain kartsound float 0.01 run scoreboard players add #kartspeedtemp kartmove 40

execute if score #kartspeed kartmove matches 1.. run function kartmobil:sound-and-fov/sr/soundmacro with storage kartmain
