...
#다음 미션 열어주기
setblock -82 5 262 oak_button
setblock -79 5 263 gold_block

execute unless score clear-data licensestage matches 11.. run scoreboard players set clear-data licensestage 11