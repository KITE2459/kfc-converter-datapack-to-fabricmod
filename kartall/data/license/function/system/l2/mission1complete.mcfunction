...
#다음 미션 열어주기
setblock -99 5 262 oak_button
setblock -96 5 263 gold_block

execute unless score clear-data licensestage matches 7.. run scoreboard players set clear-data licensestage 7