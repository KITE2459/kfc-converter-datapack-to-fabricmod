...
#다음 미션 열어주기
setblock -122 5 262 oak_button
setblock -119 5 263 gold_block

execute unless score clear-data licensestage matches 5.. run scoreboard players set clear-data licensestage 5