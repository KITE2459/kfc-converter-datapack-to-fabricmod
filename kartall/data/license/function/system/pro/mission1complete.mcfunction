...
#다음 미션 열어주기
setblock -57 5 262 oak_button
setblock -55 5 263 gold_block

execute unless score clear-data licensestage matches 13.. run scoreboard players set clear-data licensestage 13