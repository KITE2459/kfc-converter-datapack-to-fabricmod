...
#다음 미션 열어주기
setblock -61 5 262 oak_button
setblock -59 5 263 gold_block

execute unless score clear-data licensestage matches 15.. run scoreboard players set clear-data licensestage 15