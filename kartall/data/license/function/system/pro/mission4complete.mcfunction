...
#다음 미션 열어주기
setblock -63 5 262 oak_button
setblock -61 5 263 gold_block

execute unless score clear-data licensestage matches 16.. run scoreboard players set clear-data licensestage 16