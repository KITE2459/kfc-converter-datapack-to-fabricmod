...
#다음 미션 열어주기
setblock -142 5 262 oak_button
setblock -139 5 263 gold_block

execute unless score clear-data licensestage matches 2.. run scoreboard players set clear-data licensestage 2