...
# 맵 검색 및 로드 로직 (기존 trackselect 사용)
...
function master:system/game/update-bossbar-style
...
execute as @n[tag=gamemain-mapdata-marker,type=marker] at @s run function timerpack:show-track-on-sidebar/main