...
execute as @a[tag=kart-multi-player] if score @s multi-spectator-id = @a[tag=spectator-self,limit=1] multi-spectator-id run tag @s add spectator-target-temp-now
