...
#뛰라이더 연출
execute store result score #kartspeed kartmove run data get storage timeattack:timeattack-shadows temp-shadow-play.kartspeed[0]
data remove storage timeattack:timeattack-shadows temp-shadow-play.kartspeed[0]
...
execute if score #shadow-loaded dev-count matches 1 unless entity @e[tag=shadow-models] positioned ~ ~-2 ~ run function timeattack:system/shadow/summonmodel
