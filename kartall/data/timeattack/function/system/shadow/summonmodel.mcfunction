...
execute as @n[tag=dev-model-summon-temp] at @s run function kartmain:summon/summon-model with storage timeattack:timeattack-shadows temp-shadow-play
...
execute store result score @n[tag=kartdatacarrier,tag=shadow-models,type=item_display] kart-engine run data get storage timeattack:timeattack-shadows temp-shadow-play.engine
...
#개발자 모델
function timeattack:system/shadow/summon-player
